...
func (a *LogsLbDomainsAPIService) GetLbDomainsLogListExecute(r ApiGetLbDomainsLogListRequest) (*GetLbDomainsLogs, *http.Response, error) {
	...
	if r.keywordsLogType != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_log_type[]", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_log_type[]", t, "form", "multi")
		}
	} else {
		var defaultValue []LbDomainsLogsType = []LbDomainsLogsType{}
		parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_log_type[]", defaultValue, "form", "multi")
	...
	if r.keywordsOperation != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_operation[]", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_operation[]", t, "form", "multi")
		}
	} else {
		var defaultValue []LbDomainsLogsOperation = []LbDomainsLogsOperation{}
		parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_operation[]", defaultValue, "form", "multi")
	...
	if r.keywordsStatus != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_status[]", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_status[]", t, "form", "multi")
		}
	} else {
		var defaultValue []LbDomainsLogsStatus = []LbDomainsLogsStatus{}
		parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_status[]", defaultValue, "form", "multi")
