...
func (r ApiGetPingRequest) Execute() (*GetPing, *http.Response, error) {
...
//
//	@return GetPing
func (a *PingAPIService) GetPingExecute(r ApiGetPingRequest) (*GetPing, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetPing
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v InvalidAccessTokenParameterErrorResponse
