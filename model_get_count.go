...
// checks if the GetCount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCount{}

// GetCount struct for GetCount
type GetCount struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string         `json:"request_id"`
	Result    GetCountResult `json:"result"`
}

type _GetCount GetCount
...
func (o GetCount) MarshalJSON() ([]byte, error) {
...
func (o GetCount) ToMap() (map[string]interface{}, error) {
...
func (o *GetCount) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCount := _GetCount{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCount)

	if err != nil {
		return err
	}

	*o = GetCount(varGetCount)

	return err
}

type NullableGetCount struct {
	value *GetCount
	isSet bool
}

func (v NullableGetCount) Get() *GetCount {
	return v.value
}

func (v *NullableGetCount) Set(val *GetCount) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCount) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCount(val *GetCount) *NullableGetCount {
	return &NullableGetCount{value: val, isSet: true}
}

func (v NullableGetCount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCount) UnmarshalJSON(src []byte) error {
	v.isSet = true
