...
// checks if the PostCcSecNotifiedServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCcSecNotifiedServer{}

// PostCcSecNotifiedServer struct for PostCcSecNotifiedServer
type PostCcSecNotifiedServer struct {
	TsigId NullableInt64 `json:"tsig_id,omitempty"`
	// IPアドレス
	Address string `json:"address"`
}

type _PostCcSecNotifiedServer PostCcSecNotifiedServer
...
func (o *PostCcSecNotifiedServer) SetTsigIdNil() {
	o.TsigId.Set(nil)
}
...
func (o PostCcSecNotifiedServer) MarshalJSON() ([]byte, error) {
...
func (o PostCcSecNotifiedServer) ToMap() (map[string]interface{}, error) {
...
func (o *PostCcSecNotifiedServer) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCcSecNotifiedServer := _PostCcSecNotifiedServer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCcSecNotifiedServer)

	if err != nil {
		return err
	}

	*o = PostCcSecNotifiedServer(varPostCcSecNotifiedServer)

	return err
}

type NullablePostCcSecNotifiedServer struct {
	value *PostCcSecNotifiedServer
	isSet bool
}

func (v NullablePostCcSecNotifiedServer) Get() *PostCcSecNotifiedServer {
	return v.value
}

func (v *NullablePostCcSecNotifiedServer) Set(val *PostCcSecNotifiedServer) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCcSecNotifiedServer) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCcSecNotifiedServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCcSecNotifiedServer(val *PostCcSecNotifiedServer) *NullablePostCcSecNotifiedServer {
	return &NullablePostCcSecNotifiedServer{value: val, isSet: true}
}

func (v NullablePostCcSecNotifiedServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCcSecNotifiedServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
