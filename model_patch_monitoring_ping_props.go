...
// checks if the PatchMonitoringPingProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchMonitoringPingProps{}
...
func (o PatchMonitoringPingProps) MarshalJSON() ([]byte, error) {
...
type NullablePatchMonitoringPingProps struct {
	value *PatchMonitoringPingProps
	isSet bool
}

func (v NullablePatchMonitoringPingProps) Get() *PatchMonitoringPingProps {
	return v.value
}

func (v *NullablePatchMonitoringPingProps) Set(val *PatchMonitoringPingProps) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchMonitoringPingProps) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchMonitoringPingProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchMonitoringPingProps(val *PatchMonitoringPingProps) *NullablePatchMonitoringPingProps {
	return &NullablePatchMonitoringPingProps{value: val, isSet: true}
}

func (v NullablePatchMonitoringPingProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchMonitoringPingProps) UnmarshalJSON(src []byte) error {
	v.isSet = true
