...
// checks if the GetCommonConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCommonConfig{}

// GetCommonConfig struct for GetCommonConfig
type GetCommonConfig struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string       `json:"request_id"`
	Result    CommonConfig `json:"result"`
}

type _GetCommonConfig GetCommonConfig
...
func (o GetCommonConfig) MarshalJSON() ([]byte, error) {
...
func (o GetCommonConfig) ToMap() (map[string]interface{}, error) {
...
func (o *GetCommonConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCommonConfig := _GetCommonConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCommonConfig)

	if err != nil {
		return err
	}

	*o = GetCommonConfig(varGetCommonConfig)

	return err
}

type NullableGetCommonConfig struct {
	value *GetCommonConfig
	isSet bool
}

func (v NullableGetCommonConfig) Get() *GetCommonConfig {
	return v.value
}

func (v *NullableGetCommonConfig) Set(val *GetCommonConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCommonConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCommonConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCommonConfig(val *GetCommonConfig) *NullableGetCommonConfig {
	return &NullableGetCommonConfig{value: val, isSet: true}
}

func (v NullableGetCommonConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCommonConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
