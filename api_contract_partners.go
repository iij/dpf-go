...
// ContractPartnersAPIService ContractPartnersAPI service
type ContractPartnersAPIService service

type ApiGetContractPartnerListRequest struct {
	ctx        context.Context
	ApiService *ContractPartnersAPIService
	contractId string
}

func (r ApiGetContractPartnerListRequest) Execute() (*GetContractPartners, *http.Response, error) {
	return r.ApiService.GetContractPartnerListExecute(r)
}

/*
GetContractPartnerList DPF連携サービスの一覧取得

DPFが連携しているサービスの一覧を取得します。

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param contractId ID
	@return ApiGetContractPartnerListRequest
*/
func (a *ContractPartnersAPIService) GetContractPartnerList(ctx context.Context, contractId string) ApiGetContractPartnerListRequest {
	return ApiGetContractPartnerListRequest{
		ApiService: a,
		ctx:        ctx,
...
//
//	@return GetContractPartners
func (a *ContractPartnersAPIService) GetContractPartnerListExecute(r ApiGetContractPartnerListRequest) (*GetContractPartners, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetContractPartners
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContractPartnersAPIService.GetContractPartnerList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/contracts/{ContractId}/contract_partners"
