...
// checks if the PatchRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchRecord{}
...
type NullablePatchRecord struct {
	value *PatchRecord
	isSet bool
}

func (v NullablePatchRecord) Get() *PatchRecord {
	return v.value
}

func (v *NullablePatchRecord) Set(val *PatchRecord) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchRecord) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchRecord(val *PatchRecord) *NullablePatchRecord {
	return &NullablePatchRecord{value: val, isSet: true}
}

func (v NullablePatchRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
