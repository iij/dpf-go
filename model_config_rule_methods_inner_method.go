...
// checks if the ConfigRuleMethodsInnerMethod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigRuleMethodsInnerMethod{}
...
// GetParentResourceName returns the ParentResourceName field value if set, zero value otherwise.
func (o *ConfigRuleMethodsInnerMethod) GetParentResourceName() string {
	if o == nil || IsNil(o.ParentResourceName) {
		var ret string
		return ret
	}
	return *o.ParentResourceName
}

// GetParentResourceNameOk returns a tuple with the ParentResourceName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigRuleMethodsInnerMethod) GetParentResourceNameOk() (*string, bool) {
	if o == nil || IsNil(o.ParentResourceName) {
		return nil, false
	}
	return o.ParentResourceName, true
}
...
// SetParentResourceName gets a reference to the given string and assigns it to the ParentResourceName field.
...
func (o *ConfigRuleMethodsInnerMethod) GetSiteResourceName() string {
	if o == nil || IsNil(o.SiteResourceName) {
		var ret string
		return ret
	}
	return *o.SiteResourceName
}

// GetSiteResourceNameOk returns a tuple with the SiteResourceName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigRuleMethodsInnerMethod) GetSiteResourceNameOk() (*string, bool) {
	if o == nil || IsNil(o.SiteResourceName) {
		return nil, false
	}
	return o.SiteResourceName, true
}
...
func (o ConfigRuleMethodsInnerMethod) MarshalJSON() ([]byte, error) {
...
func (o *ConfigRuleMethodsInnerMethod) UnmarshalJSON(data []byte) (err error) {
	...
	varConfigRuleMethodsInnerMethod := _ConfigRuleMethodsInnerMethod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConfigRuleMethodsInnerMethod)

	if err != nil {
		return err
	}

	*o = ConfigRuleMethodsInnerMethod(varConfigRuleMethodsInnerMethod)

	return err
}

type NullableConfigRuleMethodsInnerMethod struct {
	value *ConfigRuleMethodsInnerMethod
	isSet bool
}

func (v NullableConfigRuleMethodsInnerMethod) Get() *ConfigRuleMethodsInnerMethod {
	return v.value
}

func (v *NullableConfigRuleMethodsInnerMethod) Set(val *ConfigRuleMethodsInnerMethod) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigRuleMethodsInnerMethod) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigRuleMethodsInnerMethod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigRuleMethodsInnerMethod(val *ConfigRuleMethodsInnerMethod) *NullableConfigRuleMethodsInnerMethod {
	return &NullableConfigRuleMethodsInnerMethod{value: val, isSet: true}
}

func (v NullableConfigRuleMethodsInnerMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigRuleMethodsInnerMethod) UnmarshalJSON(src []byte) error {
	v.isSet = true
