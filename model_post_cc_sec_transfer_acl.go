...
// checks if the PostCcSecTransferAcl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCcSecTransferAcl{}
...
func (o *PostCcSecTransferAcl) SetTsigIdNil() {
	o.TsigId.Set(nil)
}
...
func (o *PostCcSecTransferAcl) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCcSecTransferAcl := _PostCcSecTransferAcl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCcSecTransferAcl)

	if err != nil {
		return err
	}

	*o = PostCcSecTransferAcl(varPostCcSecTransferAcl)

	return err
}

type NullablePostCcSecTransferAcl struct {
	value *PostCcSecTransferAcl
	isSet bool
}

func (v NullablePostCcSecTransferAcl) Get() *PostCcSecTransferAcl {
	return v.value
}

func (v *NullablePostCcSecTransferAcl) Set(val *PostCcSecTransferAcl) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCcSecTransferAcl) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCcSecTransferAcl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCcSecTransferAcl(val *PostCcSecTransferAcl) *NullablePostCcSecTransferAcl {
	return &NullablePostCcSecTransferAcl{value: val, isSet: true}
}

func (v NullablePostCcSecTransferAcl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCcSecTransferAcl) UnmarshalJSON(src []byte) error {
	v.isSet = true
