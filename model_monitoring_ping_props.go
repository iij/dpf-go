...
// checks if the MonitoringPingProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonitoringPingProps{}
...
type _MonitoringPingProps MonitoringPingProps
...
func (o MonitoringPingProps) MarshalJSON() ([]byte, error) {
...
func (o *MonitoringPingProps) UnmarshalJSON(data []byte) (err error) {
	...
	varMonitoringPingProps := _MonitoringPingProps{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMonitoringPingProps)

	if err != nil {
		return err
	}

	*o = MonitoringPingProps(varMonitoringPingProps)

	return err
}

type NullableMonitoringPingProps struct {
	value *MonitoringPingProps
	isSet bool
}

func (v NullableMonitoringPingProps) Get() *MonitoringPingProps {
	return v.value
}

func (v *NullableMonitoringPingProps) Set(val *MonitoringPingProps) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitoringPingProps) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitoringPingProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitoringPingProps(val *MonitoringPingProps) *NullableMonitoringPingProps {
	return &NullableMonitoringPingProps{value: val, isSet: true}
}

func (v NullableMonitoringPingProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitoringPingProps) UnmarshalJSON(src []byte) error {
	v.isSet = true
