...
// checks if the PatchCommonConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchCommonConfig{}
...
func NewPatchCommonConfig() *PatchCommonConfig {
	this := PatchCommonConfig{}
	var description string = ""
	this.Description = &description
	return &this
}

// NewPatchCommonConfigWithDefaults instantiates a new PatchCommonConfig object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPatchCommonConfigWithDefaults() *PatchCommonConfig {
	this := PatchCommonConfig{}
	var description string = ""
	this.Description = &description
	return &this
...
func (o *PatchCommonConfig) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *PatchCommonConfig) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *PatchCommonConfig) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *PatchCommonConfig) SetDescription(v string) {
	o.Description = &v
}
...
type NullablePatchCommonConfig struct {
	value *PatchCommonConfig
	isSet bool
}

func (v NullablePatchCommonConfig) Get() *PatchCommonConfig {
	return v.value
}

func (v *NullablePatchCommonConfig) Set(val *PatchCommonConfig) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchCommonConfig) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchCommonConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchCommonConfig(val *PatchCommonConfig) *NullablePatchCommonConfig {
	return &NullablePatchCommonConfig{value: val, isSet: true}
}

func (v NullablePatchCommonConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchCommonConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
