...
// checks if the PatchCcNoticeAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchCcNoticeAccount{}
...
func (o PatchCcNoticeAccount) MarshalJSON() ([]byte, error) {
...
type NullablePatchCcNoticeAccount struct {
	value *PatchCcNoticeAccount
	isSet bool
}

func (v NullablePatchCcNoticeAccount) Get() *PatchCcNoticeAccount {
	return v.value
}

func (v *NullablePatchCcNoticeAccount) Set(val *PatchCcNoticeAccount) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchCcNoticeAccount) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchCcNoticeAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchCcNoticeAccount(val *PatchCcNoticeAccount) *NullablePatchCcNoticeAccount {
	return &NullablePatchCcNoticeAccount{value: val, isSet: true}
}

func (v NullablePatchCcNoticeAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchCcNoticeAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
