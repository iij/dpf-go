...
// checks if the MonitoringHTTP type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonitoringHTTP{}

// MonitoringHTTP struct for MonitoringHTTP
type MonitoringHTTP struct {
	...
	Props       MonitoringHTTPProps `json:"props"`
}

type _MonitoringHTTP MonitoringHTTP
...
func (o MonitoringHTTP) MarshalJSON() ([]byte, error) {
...
func (o MonitoringHTTP) ToMap() (map[string]interface{}, error) {
...
func (o *MonitoringHTTP) UnmarshalJSON(data []byte) (err error) {
	...
	varMonitoringHTTP := _MonitoringHTTP{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMonitoringHTTP)

	if err != nil {
		return err
	}

	*o = MonitoringHTTP(varMonitoringHTTP)

	return err
}

type NullableMonitoringHTTP struct {
	value *MonitoringHTTP
	isSet bool
}

func (v NullableMonitoringHTTP) Get() *MonitoringHTTP {
	return v.value
}

func (v *NullableMonitoringHTTP) Set(val *MonitoringHTTP) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitoringHTTP) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitoringHTTP) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitoringHTTP(val *MonitoringHTTP) *NullableMonitoringHTTP {
	return &NullableMonitoringHTTP{value: val, isSet: true}
}

func (v NullableMonitoringHTTP) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitoringHTTP) UnmarshalJSON(src []byte) error {
	v.isSet = true
