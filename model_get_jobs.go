...
// checks if the GetJobs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetJobs{}
...
func (o *GetJobs) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varGetJobs)

	if err != nil {
		return err
	}

	*o = GetJobs(varGetJobs)

	return err
}

type NullableGetJobs struct {
	value *GetJobs
	isSet bool
}

func (v NullableGetJobs) Get() *GetJobs {
	return v.value
}

func (v *NullableGetJobs) Set(val *GetJobs) {
	v.value = val
	v.isSet = true
}

func (v NullableGetJobs) IsSet() bool {
	return v.isSet
}

func (v *NullableGetJobs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetJobs(val *GetJobs) *NullableGetJobs {
	return &NullableGetJobs{value: val, isSet: true}
}

func (v NullableGetJobs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetJobs) UnmarshalJSON(src []byte) error {
	v.isSet = true
