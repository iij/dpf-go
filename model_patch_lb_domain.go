...
// checks if the PatchLbDomain type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchLbDomain{}
...
func (o *PatchLbDomain) GetRuleResourceName() string {
	if o == nil || IsNil(o.RuleResourceName) {
		var ret string
		return ret
	}
...
// GetRuleResourceNameOk returns a tuple with the RuleResourceName field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetRuleResourceName gets a reference to the given string and assigns it to the RuleResourceName field.
func (o *PatchLbDomain) SetRuleResourceName(v string) {
	o.RuleResourceName = &v
}

func (o PatchLbDomain) MarshalJSON() ([]byte, error) {
...
type NullablePatchLbDomain struct {
	value *PatchLbDomain
	isSet bool
}

func (v NullablePatchLbDomain) Get() *PatchLbDomain {
	return v.value
}

func (v *NullablePatchLbDomain) Set(val *PatchLbDomain) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchLbDomain) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchLbDomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchLbDomain(val *PatchLbDomain) *NullablePatchLbDomain {
	return &NullablePatchLbDomain{value: val, isSet: true}
}

func (v NullablePatchLbDomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchLbDomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
