...
// checks if the GetTsigsCommonConfigs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTsigsCommonConfigs{}

// GetTsigsCommonConfigs struct for GetTsigsCommonConfigs
type GetTsigsCommonConfigs struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string         `json:"request_id"`
	Results   []CommonConfig `json:"results"`
}

type _GetTsigsCommonConfigs GetTsigsCommonConfigs
...
func (o GetTsigsCommonConfigs) MarshalJSON() ([]byte, error) {
...
func (o GetTsigsCommonConfigs) ToMap() (map[string]interface{}, error) {
...
func (o *GetTsigsCommonConfigs) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTsigsCommonConfigs := _GetTsigsCommonConfigs{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTsigsCommonConfigs)

	if err != nil {
		return err
	}

	*o = GetTsigsCommonConfigs(varGetTsigsCommonConfigs)

	return err
}

type NullableGetTsigsCommonConfigs struct {
	value *GetTsigsCommonConfigs
	isSet bool
}

func (v NullableGetTsigsCommonConfigs) Get() *GetTsigsCommonConfigs {
	return v.value
}

func (v *NullableGetTsigsCommonConfigs) Set(val *GetTsigsCommonConfigs) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTsigsCommonConfigs) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTsigsCommonConfigs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTsigsCommonConfigs(val *GetTsigsCommonConfigs) *NullableGetTsigsCommonConfigs {
	return &NullableGetTsigsCommonConfigs{value: val, isSet: true}
}

func (v NullableGetTsigsCommonConfigs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTsigsCommonConfigs) UnmarshalJSON(src []byte) error {
	v.isSet = true
