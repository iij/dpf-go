...
// checks if the PutConfigSitesInnerEndpointsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutConfigSitesInnerEndpointsInner{}
...
func (o *PutConfigSitesInnerEndpointsInner) GetMonitorings() []PutConfigSitesInnerEndpointsInnerMonitoringsInner {
	if o == nil {
		var ret []PutConfigSitesInnerEndpointsInnerMonitoringsInner
		return ret
	}
...
func (o *PutConfigSitesInnerEndpointsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varPutConfigSitesInnerEndpointsInner := _PutConfigSitesInnerEndpointsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutConfigSitesInnerEndpointsInner)

	if err != nil {
		return err
	}

	*o = PutConfigSitesInnerEndpointsInner(varPutConfigSitesInnerEndpointsInner)

	return err
}

type NullablePutConfigSitesInnerEndpointsInner struct {
	value *PutConfigSitesInnerEndpointsInner
	isSet bool
}

func (v NullablePutConfigSitesInnerEndpointsInner) Get() *PutConfigSitesInnerEndpointsInner {
	return v.value
}

func (v *NullablePutConfigSitesInnerEndpointsInner) Set(val *PutConfigSitesInnerEndpointsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePutConfigSitesInnerEndpointsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePutConfigSitesInnerEndpointsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutConfigSitesInnerEndpointsInner(val *PutConfigSitesInnerEndpointsInner) *NullablePutConfigSitesInnerEndpointsInner {
	return &NullablePutConfigSitesInnerEndpointsInner{value: val, isSet: true}
}

func (v NullablePutConfigSitesInnerEndpointsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutConfigSitesInnerEndpointsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
