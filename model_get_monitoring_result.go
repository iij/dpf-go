...
// checks if the GetMonitoringResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMonitoringResult{}
...
func (o GetMonitoringResult) MarshalJSON() ([]byte, error) {
...
func (o *GetMonitoringResult) UnmarshalJSON(data []byte) (err error) {
	...
	varGetMonitoringResult := _GetMonitoringResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetMonitoringResult)

	if err != nil {
		return err
	}

	*o = GetMonitoringResult(varGetMonitoringResult)

	return err
}

type NullableGetMonitoringResult struct {
	value *GetMonitoringResult
	isSet bool
}

func (v NullableGetMonitoringResult) Get() *GetMonitoringResult {
	return v.value
}

func (v *NullableGetMonitoringResult) Set(val *GetMonitoringResult) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMonitoringResult) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMonitoringResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMonitoringResult(val *GetMonitoringResult) *NullableGetMonitoringResult {
	return &NullableGetMonitoringResult{value: val, isSet: true}
}

func (v NullableGetMonitoringResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMonitoringResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
