...
// checks if the PostEndpointMonitoringsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostEndpointMonitoringsInner{}
...
func (o *PostEndpointMonitoringsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varPostEndpointMonitoringsInner := _PostEndpointMonitoringsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostEndpointMonitoringsInner)

	if err != nil {
		return err
	}

	*o = PostEndpointMonitoringsInner(varPostEndpointMonitoringsInner)

	return err
}

type NullablePostEndpointMonitoringsInner struct {
	value *PostEndpointMonitoringsInner
	isSet bool
}

func (v NullablePostEndpointMonitoringsInner) Get() *PostEndpointMonitoringsInner {
	return v.value
}

func (v *NullablePostEndpointMonitoringsInner) Set(val *PostEndpointMonitoringsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePostEndpointMonitoringsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePostEndpointMonitoringsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostEndpointMonitoringsInner(val *PostEndpointMonitoringsInner) *NullablePostEndpointMonitoringsInner {
	return &NullablePostEndpointMonitoringsInner{value: val, isSet: true}
}

func (v NullablePostEndpointMonitoringsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostEndpointMonitoringsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
