...
// checks if the ConfigRuleMethodsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigRuleMethodsInner{}
...
func (o *ConfigRuleMethodsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varConfigRuleMethodsInner := _ConfigRuleMethodsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConfigRuleMethodsInner)

	if err != nil {
		return err
	}

	*o = ConfigRuleMethodsInner(varConfigRuleMethodsInner)

	return err
}

type NullableConfigRuleMethodsInner struct {
	value *ConfigRuleMethodsInner
	isSet bool
}

func (v NullableConfigRuleMethodsInner) Get() *ConfigRuleMethodsInner {
	return v.value
}

func (v *NullableConfigRuleMethodsInner) Set(val *ConfigRuleMethodsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigRuleMethodsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigRuleMethodsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigRuleMethodsInner(val *ConfigRuleMethodsInner) *NullableConfigRuleMethodsInner {
	return &NullableConfigRuleMethodsInner{value: val, isSet: true}
}

func (v NullableConfigRuleMethodsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigRuleMethodsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
