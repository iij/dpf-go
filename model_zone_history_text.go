...
// checks if the ZoneHistoryText type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneHistoryText{}

// ZoneHistoryText struct for ZoneHistoryText
type ZoneHistoryText struct {
	Id          int64     `json:"id"`
...
type _ZoneHistoryText ZoneHistoryText
...
func (o ZoneHistoryText) MarshalJSON() ([]byte, error) {
...
func (o ZoneHistoryText) ToMap() (map[string]interface{}, error) {
...
func (o *ZoneHistoryText) UnmarshalJSON(data []byte) (err error) {
	...
	varZoneHistoryText := _ZoneHistoryText{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varZoneHistoryText)

	if err != nil {
		return err
	}

	*o = ZoneHistoryText(varZoneHistoryText)

	return err
}

type NullableZoneHistoryText struct {
	value *ZoneHistoryText
	isSet bool
}

func (v NullableZoneHistoryText) Get() *ZoneHistoryText {
	return v.value
}

func (v *NullableZoneHistoryText) Set(val *ZoneHistoryText) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneHistoryText) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneHistoryText) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneHistoryText(val *ZoneHistoryText) *NullableZoneHistoryText {
	return &NullableZoneHistoryText{value: val, isSet: true}
}

func (v NullableZoneHistoryText) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneHistoryText) UnmarshalJSON(src []byte) error {
	v.isSet = true
