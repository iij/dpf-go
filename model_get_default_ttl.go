...
// checks if the GetDefaultTtl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDefaultTtl{}

// GetDefaultTtl struct for GetDefaultTtl
type GetDefaultTtl struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string     `json:"request_id"`
	Result    DefaultTtl `json:"result"`
}

type _GetDefaultTtl GetDefaultTtl
...
func (o GetDefaultTtl) MarshalJSON() ([]byte, error) {
...
func (o GetDefaultTtl) ToMap() (map[string]interface{}, error) {
...
func (o *GetDefaultTtl) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDefaultTtl := _GetDefaultTtl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetDefaultTtl)

	if err != nil {
		return err
	}

	*o = GetDefaultTtl(varGetDefaultTtl)

	return err
}

type NullableGetDefaultTtl struct {
	value *GetDefaultTtl
	isSet bool
}

func (v NullableGetDefaultTtl) Get() *GetDefaultTtl {
	return v.value
}

func (v *NullableGetDefaultTtl) Set(val *GetDefaultTtl) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDefaultTtl) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDefaultTtl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDefaultTtl(val *GetDefaultTtl) *NullableGetDefaultTtl {
	return &NullableGetDefaultTtl{value: val, isSet: true}
}

func (v NullableGetDefaultTtl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDefaultTtl) UnmarshalJSON(src []byte) error {
	v.isSet = true
