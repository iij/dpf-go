...
// checks if the PatchMonitoringTCPProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchMonitoringTCPProps{}
...
func (o PatchMonitoringTCPProps) MarshalJSON() ([]byte, error) {
...
type NullablePatchMonitoringTCPProps struct {
	value *PatchMonitoringTCPProps
	isSet bool
}

func (v NullablePatchMonitoringTCPProps) Get() *PatchMonitoringTCPProps {
	return v.value
}

func (v *NullablePatchMonitoringTCPProps) Set(val *PatchMonitoringTCPProps) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchMonitoringTCPProps) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchMonitoringTCPProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchMonitoringTCPProps(val *PatchMonitoringTCPProps) *NullablePatchMonitoringTCPProps {
	return &NullablePatchMonitoringTCPProps{value: val, isSet: true}
}

func (v NullablePatchMonitoringTCPProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchMonitoringTCPProps) UnmarshalJSON(src []byte) error {
	v.isSet = true
