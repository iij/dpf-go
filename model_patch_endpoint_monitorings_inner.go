...
// checks if the PatchEndpointMonitoringsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchEndpointMonitoringsInner{}
...
func (o *PatchEndpointMonitoringsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchEndpointMonitoringsInner := _PatchEndpointMonitoringsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPatchEndpointMonitoringsInner)

	if err != nil {
		return err
	}

	*o = PatchEndpointMonitoringsInner(varPatchEndpointMonitoringsInner)

	return err
}

type NullablePatchEndpointMonitoringsInner struct {
	value *PatchEndpointMonitoringsInner
	isSet bool
}

func (v NullablePatchEndpointMonitoringsInner) Get() *PatchEndpointMonitoringsInner {
	return v.value
}

func (v *NullablePatchEndpointMonitoringsInner) Set(val *PatchEndpointMonitoringsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchEndpointMonitoringsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchEndpointMonitoringsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchEndpointMonitoringsInner(val *PatchEndpointMonitoringsInner) *NullablePatchEndpointMonitoringsInner {
	return &NullablePatchEndpointMonitoringsInner{value: val, isSet: true}
}

func (v NullablePatchEndpointMonitoringsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchEndpointMonitoringsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
