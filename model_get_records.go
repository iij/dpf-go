...
// checks if the GetRecords type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRecords{}

// GetRecords struct for GetRecords
...
func (o GetRecords) MarshalJSON() ([]byte, error) {
...
func (o GetRecords) ToMap() (map[string]interface{}, error) {
...
func (o *GetRecords) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRecords := _GetRecords{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRecords)

	if err != nil {
		return err
	}

	*o = GetRecords(varGetRecords)

	return err
}

type NullableGetRecords struct {
	value *GetRecords
	isSet bool
}

func (v NullableGetRecords) Get() *GetRecords {
	return v.value
}

func (v *NullableGetRecords) Set(val *GetRecords) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRecords) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRecords) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRecords(val *GetRecords) *NullableGetRecords {
	return &NullableGetRecords{value: val, isSet: true}
}

func (v NullableGetRecords) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRecords) UnmarshalJSON(src []byte) error {
	v.isSet = true
