...
// checks if the PutConfigSitesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutConfigSitesInner{}

// PutConfigSitesInner struct for PutConfigSitesInner
type PutConfigSitesInner struct {
	...
	Endpoints   []PutConfigSitesInnerEndpointsInner `json:"endpoints"`
}

type _PutConfigSitesInner PutConfigSitesInner
...
func (o *PutConfigSitesInner) GetEndpoints() []PutConfigSitesInnerEndpointsInner {
	if o == nil {
		var ret []PutConfigSitesInnerEndpointsInner
		return ret
	}
...
func (o PutConfigSitesInner) MarshalJSON() ([]byte, error) {
...
func (o PutConfigSitesInner) ToMap() (map[string]interface{}, error) {
...
func (o *PutConfigSitesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varPutConfigSitesInner := _PutConfigSitesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutConfigSitesInner)

	if err != nil {
		return err
	}

	*o = PutConfigSitesInner(varPutConfigSitesInner)

	return err
}

type NullablePutConfigSitesInner struct {
	value *PutConfigSitesInner
	isSet bool
}

func (v NullablePutConfigSitesInner) Get() *PutConfigSitesInner {
	return v.value
}

func (v *NullablePutConfigSitesInner) Set(val *PutConfigSitesInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePutConfigSitesInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePutConfigSitesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutConfigSitesInner(val *PutConfigSitesInner) *NullablePutConfigSitesInner {
	return &NullablePutConfigSitesInner{value: val, isSet: true}
}

func (v NullablePutConfigSitesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutConfigSitesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
