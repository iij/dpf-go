...
// checks if the PostCcNoticeAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCcNoticeAccount{}
...
// SetProps gets a reference to the given CcNoticeAccountProps and assigns it to the Props field.
...
func (o *PostCcNoticeAccount) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCcNoticeAccount := _PostCcNoticeAccount{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCcNoticeAccount)

	if err != nil {
		return err
	}

	*o = PostCcNoticeAccount(varPostCcNoticeAccount)

	return err
}

type NullablePostCcNoticeAccount struct {
	value *PostCcNoticeAccount
	isSet bool
}

func (v NullablePostCcNoticeAccount) Get() *PostCcNoticeAccount {
	return v.value
}

func (v *NullablePostCcNoticeAccount) Set(val *PostCcNoticeAccount) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCcNoticeAccount) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCcNoticeAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCcNoticeAccount(val *PostCcNoticeAccount) *NullablePostCcNoticeAccount {
	return &NullablePostCcNoticeAccount{value: val, isSet: true}
}

func (v NullablePostCcNoticeAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCcNoticeAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
