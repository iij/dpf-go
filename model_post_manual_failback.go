...
// checks if the PostManualFailback type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostManualFailback{}

// PostManualFailback struct for PostManualFailback
type PostManualFailback struct {
...
func (o PostManualFailback) MarshalJSON() ([]byte, error) {
...
func (o PostManualFailback) ToMap() (map[string]interface{}, error) {
...
type NullablePostManualFailback struct {
	value *PostManualFailback
	isSet bool
}

func (v NullablePostManualFailback) Get() *PostManualFailback {
	return v.value
}

func (v *NullablePostManualFailback) Set(val *PostManualFailback) {
	v.value = val
	v.isSet = true
}

func (v NullablePostManualFailback) IsSet() bool {
	return v.isSet
}

func (v *NullablePostManualFailback) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostManualFailback(val *PostManualFailback) *NullablePostManualFailback {
	return &NullablePostManualFailback{value: val, isSet: true}
}

func (v NullablePostManualFailback) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostManualFailback) UnmarshalJSON(src []byte) error {
	v.isSet = true
