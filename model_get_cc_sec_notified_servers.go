...
// checks if the GetCcSecNotifiedServers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCcSecNotifiedServers{}

// GetCcSecNotifiedServers struct for GetCcSecNotifiedServers
type GetCcSecNotifiedServers struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string           `json:"request_id"`
	Results   []NotifiedServer `json:"results"`
}

type _GetCcSecNotifiedServers GetCcSecNotifiedServers
...
func (o GetCcSecNotifiedServers) MarshalJSON() ([]byte, error) {
...
func (o GetCcSecNotifiedServers) ToMap() (map[string]interface{}, error) {
...
func (o *GetCcSecNotifiedServers) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCcSecNotifiedServers := _GetCcSecNotifiedServers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCcSecNotifiedServers)

	if err != nil {
		return err
	}

	*o = GetCcSecNotifiedServers(varGetCcSecNotifiedServers)

	return err
}

type NullableGetCcSecNotifiedServers struct {
	value *GetCcSecNotifiedServers
	isSet bool
}

func (v NullableGetCcSecNotifiedServers) Get() *GetCcSecNotifiedServers {
	return v.value
}

func (v *NullableGetCcSecNotifiedServers) Set(val *GetCcSecNotifiedServers) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCcSecNotifiedServers) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCcSecNotifiedServers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCcSecNotifiedServers(val *GetCcSecNotifiedServers) *NullableGetCcSecNotifiedServers {
	return &NullableGetCcSecNotifiedServers{value: val, isSet: true}
}

func (v NullableGetCcSecNotifiedServers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCcSecNotifiedServers) UnmarshalJSON(src []byte) error {
	v.isSet = true
