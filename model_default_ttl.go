...
// checks if the DefaultTtl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefaultTtl{}
...
func (o *DefaultTtl) UnmarshalJSON(data []byte) (err error) {
	...
	varDefaultTtl := _DefaultTtl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDefaultTtl)

	if err != nil {
		return err
	}

	*o = DefaultTtl(varDefaultTtl)

	return err
}

type NullableDefaultTtl struct {
	value *DefaultTtl
	isSet bool
}

func (v NullableDefaultTtl) Get() *DefaultTtl {
	return v.value
}

func (v *NullableDefaultTtl) Set(val *DefaultTtl) {
	v.value = val
	v.isSet = true
}

func (v NullableDefaultTtl) IsSet() bool {
	return v.isSet
}

func (v *NullableDefaultTtl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDefaultTtl(val *DefaultTtl) *NullableDefaultTtl {
	return &NullableDefaultTtl{value: val, isSet: true}
}

func (v NullableDefaultTtl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDefaultTtl) UnmarshalJSON(src []byte) error {
	v.isSet = true
