...
// checks if the GetZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZone{}

// GetZone struct for GetZone
type GetZone struct {
	// 処理の問い合わせの際のキーになる文字列
...
func (o GetZone) MarshalJSON() ([]byte, error) {
...
func (o GetZone) ToMap() (map[string]interface{}, error) {
...
func (o *GetZone) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varGetZone)

	if err != nil {
		return err
	}

	*o = GetZone(varGetZone)

	return err
}

type NullableGetZone struct {
	value *GetZone
	isSet bool
}

func (v NullableGetZone) Get() *GetZone {
	return v.value
}

func (v *NullableGetZone) Set(val *GetZone) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZone) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZone(val *GetZone) *NullableGetZone {
	return &NullableGetZone{value: val, isSet: true}
}

func (v NullableGetZone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZone) UnmarshalJSON(src []byte) error {
	v.isSet = true
