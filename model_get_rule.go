...
// checks if the GetRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRule{}

// GetRule struct for GetRule
type GetRule struct {
	// 処理の問い合わせの際のキーになる文字列
...
func (o GetRule) MarshalJSON() ([]byte, error) {
...
func (o GetRule) ToMap() (map[string]interface{}, error) {
...
func (o *GetRule) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varGetRule)

	if err != nil {
		return err
	}

	*o = GetRule(varGetRule)

	return err
}

type NullableGetRule struct {
	value *GetRule
	isSet bool
}

func (v NullableGetRule) Get() *GetRule {
	return v.value
}

func (v *NullableGetRule) Set(val *GetRule) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRule) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRule(val *GetRule) *NullableGetRule {
	return &NullableGetRule{value: val, isSet: true}
}

func (v NullableGetRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
