...
// checks if the GetQpsHistories type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetQpsHistories{}

// GetQpsHistories struct for GetQpsHistories
type GetQpsHistories struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string       `json:"request_id"`
	Results   []QpsHistory `json:"results"`
}

type _GetQpsHistories GetQpsHistories
...
func (o GetQpsHistories) MarshalJSON() ([]byte, error) {
...
func (o GetQpsHistories) ToMap() (map[string]interface{}, error) {
...
func (o *GetQpsHistories) UnmarshalJSON(data []byte) (err error) {
	...
	varGetQpsHistories := _GetQpsHistories{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetQpsHistories)

	if err != nil {
		return err
	}

	*o = GetQpsHistories(varGetQpsHistories)

	return err
}

type NullableGetQpsHistories struct {
	value *GetQpsHistories
	isSet bool
}

func (v NullableGetQpsHistories) Get() *GetQpsHistories {
	return v.value
}

func (v *NullableGetQpsHistories) Set(val *GetQpsHistories) {
	v.value = val
	v.isSet = true
}

func (v NullableGetQpsHistories) IsSet() bool {
	return v.isSet
}

func (v *NullableGetQpsHistories) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetQpsHistories(val *GetQpsHistories) *NullableGetQpsHistories {
	return &NullableGetQpsHistories{value: val, isSet: true}
}

func (v NullableGetQpsHistories) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetQpsHistories) UnmarshalJSON(src []byte) error {
	v.isSet = true
