...
// checks if the PostCcPrimary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCcPrimary{}
...
func (o *PostCcPrimary) SetTsigIdNil() {
	o.TsigId.Set(nil)
}
...
func (o *PostCcPrimary) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCcPrimary := _PostCcPrimary{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCcPrimary)

	if err != nil {
		return err
	}

	*o = PostCcPrimary(varPostCcPrimary)

	return err
}

type NullablePostCcPrimary struct {
	value *PostCcPrimary
	isSet bool
}

func (v NullablePostCcPrimary) Get() *PostCcPrimary {
	return v.value
}

func (v *NullablePostCcPrimary) Set(val *PostCcPrimary) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCcPrimary) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCcPrimary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCcPrimary(val *PostCcPrimary) *NullablePostCcPrimary {
	return &NullablePostCcPrimary{value: val, isSet: true}
}

func (v NullablePostCcPrimary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCcPrimary) UnmarshalJSON(src []byte) error {
	v.isSet = true
