...
func (o *Rule) GetMethods() []RuleMethodsInner {
	if o == nil {
		var ret []RuleMethodsInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Rule) GetMethodsOk() ([]RuleMethodsInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Rule) SetMethods(v []RuleMethodsInner) {
	o.Methods = v
}
