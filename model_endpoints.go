...
func (o *Endpoints) GetEndpoints() []Endpoint {
...
func (o *Endpoints) GetEndpointsOk() ([]Endpoint, bool) {
	if o == nil || IsNil(o.Endpoints) {
		return nil, false
	}
...
func (o *Endpoints) HasEndpoints() bool {
	if o != nil && !IsNil(o.Endpoints) {
		return true
	}
...
func (o *Endpoints) SetEndpoints(v []Endpoint) {
	o.Endpoints = v
}
