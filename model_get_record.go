...
// checks if the GetRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRecord{}

// GetRecord struct for GetRecord
...
func (o GetRecord) MarshalJSON() ([]byte, error) {
...
func (o GetRecord) ToMap() (map[string]interface{}, error) {
...
func (o *GetRecord) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRecord := _GetRecord{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRecord)

	if err != nil {
		return err
	}

	*o = GetRecord(varGetRecord)

	return err
}

type NullableGetRecord struct {
	value *GetRecord
	isSet bool
}

func (v NullableGetRecord) Get() *GetRecord {
	return v.value
}

func (v *NullableGetRecord) Set(val *GetRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRecord(val *GetRecord) *NullableGetRecord {
	return &NullableGetRecord{value: val, isSet: true}
}

func (v NullableGetRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
