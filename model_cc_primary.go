...
// checks if the CcPrimary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CcPrimary{}
...
func (o *CcPrimary) UnmarshalJSON(data []byte) (err error) {
	...
	varCcPrimary := _CcPrimary{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCcPrimary)

	if err != nil {
		return err
	}

	*o = CcPrimary(varCcPrimary)

	return err
}

type NullableCcPrimary struct {
	value *CcPrimary
	isSet bool
}

func (v NullableCcPrimary) Get() *CcPrimary {
	return v.value
}

func (v *NullableCcPrimary) Set(val *CcPrimary) {
	v.value = val
	v.isSet = true
}

func (v NullableCcPrimary) IsSet() bool {
	return v.isSet
}

func (v *NullableCcPrimary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcPrimary(val *CcPrimary) *NullableCcPrimary {
	return &NullableCcPrimary{value: val, isSet: true}
}

func (v NullableCcPrimary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCcPrimary) UnmarshalJSON(src []byte) error {
	v.isSet = true
