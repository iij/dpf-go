...
// checks if the MonitoringTCP type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonitoringTCP{}

// MonitoringTCP struct for MonitoringTCP
type MonitoringTCP struct {
	...
	Props       MonitoringTCPProps `json:"props"`
}

type _MonitoringTCP MonitoringTCP
...
func (o MonitoringTCP) MarshalJSON() ([]byte, error) {
...
func (o MonitoringTCP) ToMap() (map[string]interface{}, error) {
...
func (o *MonitoringTCP) UnmarshalJSON(data []byte) (err error) {
	...
	varMonitoringTCP := _MonitoringTCP{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMonitoringTCP)

	if err != nil {
		return err
	}

	*o = MonitoringTCP(varMonitoringTCP)

	return err
}

type NullableMonitoringTCP struct {
	value *MonitoringTCP
	isSet bool
}

func (v NullableMonitoringTCP) Get() *MonitoringTCP {
	return v.value
}

func (v *NullableMonitoringTCP) Set(val *MonitoringTCP) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitoringTCP) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitoringTCP) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitoringTCP(val *MonitoringTCP) *NullableMonitoringTCP {
	return &NullableMonitoringTCP{value: val, isSet: true}
}

func (v NullableMonitoringTCP) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitoringTCP) UnmarshalJSON(src []byte) error {
	v.isSet = true
