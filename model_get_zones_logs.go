...
// checks if the GetZonesLogs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZonesLogs{}

// GetZonesLogs struct for GetZonesLogs
type GetZonesLogs struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string     `json:"request_id"`
	Results   []ZonesLog `json:"results"`
}

type _GetZonesLogs GetZonesLogs
...
func (o GetZonesLogs) MarshalJSON() ([]byte, error) {
...
func (o GetZonesLogs) ToMap() (map[string]interface{}, error) {
...
func (o *GetZonesLogs) UnmarshalJSON(data []byte) (err error) {
	...
	varGetZonesLogs := _GetZonesLogs{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetZonesLogs)

	if err != nil {
		return err
	}

	*o = GetZonesLogs(varGetZonesLogs)

	return err
}

type NullableGetZonesLogs struct {
	value *GetZonesLogs
	isSet bool
}

func (v NullableGetZonesLogs) Get() *GetZonesLogs {
	return v.value
}

func (v *NullableGetZonesLogs) Set(val *GetZonesLogs) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZonesLogs) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZonesLogs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZonesLogs(val *GetZonesLogs) *NullableGetZonesLogs {
	return &NullableGetZonesLogs{value: val, isSet: true}
}

func (v NullableGetZonesLogs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZonesLogs) UnmarshalJSON(src []byte) error {
	v.isSet = true
