...
// checks if the GetRules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRules{}

// GetRules struct for GetRules
...
func (o GetRules) MarshalJSON() ([]byte, error) {
...
func (o GetRules) ToMap() (map[string]interface{}, error) {
...
func (o *GetRules) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRules := _GetRules{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRules)

	if err != nil {
		return err
	}

	*o = GetRules(varGetRules)

	return err
}

type NullableGetRules struct {
	value *GetRules
	isSet bool
}

func (v NullableGetRules) Get() *GetRules {
	return v.value
}

func (v *NullableGetRules) Set(val *GetRules) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRules) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRules(val *GetRules) *NullableGetRules {
	return &NullableGetRules{value: val, isSet: true}
}

func (v NullableGetRules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRules) UnmarshalJSON(src []byte) error {
	v.isSet = true
