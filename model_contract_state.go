...
// ContractState 詳細説明は[**こちら**](#tag/contracts)
type ContractState int32

// List of ContractState
const (
	CONTRACTSTATE__1 ContractState = 1
	CONTRACTSTATE__2 ContractState = 2
)
...
func NewContractStateFromValue(v int32) (*ContractState, error) {
	ev := ContractState(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
