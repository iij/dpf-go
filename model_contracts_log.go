...
// checks if the ContractsLog type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContractsLog{}
...
func (o *ContractsLog) GetOperation() ContractsLogsOperation {
	if o == nil {
		var ret ContractsLogsOperation
		return ret
	}
...
func (o *ContractsLog) UnmarshalJSON(data []byte) (err error) {
	...
	varContractsLog := _ContractsLog{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varContractsLog)

	if err != nil {
		return err
	}

	*o = ContractsLog(varContractsLog)

	return err
}

type NullableContractsLog struct {
	value *ContractsLog
	isSet bool
}

func (v NullableContractsLog) Get() *ContractsLog {
	return v.value
}

func (v *NullableContractsLog) Set(val *ContractsLog) {
	v.value = val
	v.isSet = true
}

func (v NullableContractsLog) IsSet() bool {
	return v.isSet
}

func (v *NullableContractsLog) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContractsLog(val *ContractsLog) *NullableContractsLog {
	return &NullableContractsLog{value: val, isSet: true}
}

func (v NullableContractsLog) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContractsLog) UnmarshalJSON(src []byte) error {
	v.isSet = true
