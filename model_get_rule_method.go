...
// checks if the GetRuleMethod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRuleMethod{}

// GetRuleMethod struct for GetRuleMethod
type GetRuleMethod struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string     `json:"request_id"`
	Result    RuleMethod `json:"result"`
}

type _GetRuleMethod GetRuleMethod
...
func (o GetRuleMethod) MarshalJSON() ([]byte, error) {
...
func (o GetRuleMethod) ToMap() (map[string]interface{}, error) {
...
func (o *GetRuleMethod) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRuleMethod := _GetRuleMethod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRuleMethod)

	if err != nil {
		return err
	}

	*o = GetRuleMethod(varGetRuleMethod)

	return err
}

type NullableGetRuleMethod struct {
	value *GetRuleMethod
	isSet bool
}

func (v NullableGetRuleMethod) Get() *GetRuleMethod {
	return v.value
}

func (v *NullableGetRuleMethod) Set(val *GetRuleMethod) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRuleMethod) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRuleMethod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRuleMethod(val *GetRuleMethod) *NullableGetRuleMethod {
	return &NullableGetRuleMethod{value: val, isSet: true}
}

func (v NullableGetRuleMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRuleMethod) UnmarshalJSON(src []byte) error {
	v.isSet = true
