...
// checks if the GetZoneHistories type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZoneHistories{}

// GetZoneHistories struct for GetZoneHistories
type GetZoneHistories struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string        `json:"request_id"`
	Results   []ZoneHistory `json:"results"`
}

type _GetZoneHistories GetZoneHistories
...
func (o GetZoneHistories) MarshalJSON() ([]byte, error) {
...
func (o GetZoneHistories) ToMap() (map[string]interface{}, error) {
...
func (o *GetZoneHistories) UnmarshalJSON(data []byte) (err error) {
	...
	varGetZoneHistories := _GetZoneHistories{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetZoneHistories)

	if err != nil {
		return err
	}

	*o = GetZoneHistories(varGetZoneHistories)

	return err
}

type NullableGetZoneHistories struct {
	value *GetZoneHistories
	isSet bool
}

func (v NullableGetZoneHistories) Get() *GetZoneHistories {
	return v.value
}

func (v *NullableGetZoneHistories) Set(val *GetZoneHistories) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZoneHistories) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZoneHistories) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZoneHistories(val *GetZoneHistories) *NullableGetZoneHistories {
	return &NullableGetZoneHistories{value: val, isSet: true}
}

func (v NullableGetZoneHistories) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZoneHistories) UnmarshalJSON(src []byte) error {
	v.isSet = true
