...
// checks if the CcNoticeAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CcNoticeAccount{}
...
func (o *CcNoticeAccount) UnmarshalJSON(data []byte) (err error) {
	...
	varCcNoticeAccount := _CcNoticeAccount{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCcNoticeAccount)

	if err != nil {
		return err
	}

	*o = CcNoticeAccount(varCcNoticeAccount)

	return err
}

type NullableCcNoticeAccount struct {
	value *CcNoticeAccount
	isSet bool
}

func (v NullableCcNoticeAccount) Get() *CcNoticeAccount {
	return v.value
}

func (v *NullableCcNoticeAccount) Set(val *CcNoticeAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableCcNoticeAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableCcNoticeAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcNoticeAccount(val *CcNoticeAccount) *NullableCcNoticeAccount {
	return &NullableCcNoticeAccount{value: val, isSet: true}
}

func (v NullableCcNoticeAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCcNoticeAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
