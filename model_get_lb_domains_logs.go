...
// checks if the GetLbDomainsLogs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLbDomainsLogs{}

// GetLbDomainsLogs struct for GetLbDomainsLogs
type GetLbDomainsLogs struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string         `json:"request_id"`
	Results   []LbDomainsLog `json:"results"`
}

type _GetLbDomainsLogs GetLbDomainsLogs
...
func (o GetLbDomainsLogs) MarshalJSON() ([]byte, error) {
...
func (o GetLbDomainsLogs) ToMap() (map[string]interface{}, error) {
...
func (o *GetLbDomainsLogs) UnmarshalJSON(data []byte) (err error) {
	...
	varGetLbDomainsLogs := _GetLbDomainsLogs{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetLbDomainsLogs)

	if err != nil {
		return err
	}

	*o = GetLbDomainsLogs(varGetLbDomainsLogs)

	return err
}

type NullableGetLbDomainsLogs struct {
	value *GetLbDomainsLogs
	isSet bool
}

func (v NullableGetLbDomainsLogs) Get() *GetLbDomainsLogs {
	return v.value
}

func (v *NullableGetLbDomainsLogs) Set(val *GetLbDomainsLogs) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLbDomainsLogs) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLbDomainsLogs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLbDomainsLogs(val *GetLbDomainsLogs) *NullableGetLbDomainsLogs {
	return &NullableGetLbDomainsLogs{value: val, isSet: true}
}

func (v NullableGetLbDomainsLogs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLbDomainsLogs) UnmarshalJSON(src []byte) error {
	v.isSet = true
