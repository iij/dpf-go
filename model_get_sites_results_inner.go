...
// checks if the GetSitesResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSitesResultsInner{}

// GetSitesResultsInner struct for GetSitesResultsInner
type GetSitesResultsInner struct {
...
type _GetSitesResultsInner GetSitesResultsInner
...
func (o GetSitesResultsInner) MarshalJSON() ([]byte, error) {
...
func (o GetSitesResultsInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetSitesResultsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSitesResultsInner := _GetSitesResultsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetSitesResultsInner)

	if err != nil {
		return err
	}

	*o = GetSitesResultsInner(varGetSitesResultsInner)

	return err
}

type NullableGetSitesResultsInner struct {
	value *GetSitesResultsInner
	isSet bool
}

func (v NullableGetSitesResultsInner) Get() *GetSitesResultsInner {
	return v.value
}

func (v *NullableGetSitesResultsInner) Set(val *GetSitesResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSitesResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSitesResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSitesResultsInner(val *GetSitesResultsInner) *NullableGetSitesResultsInner {
	return &NullableGetSitesResultsInner{value: val, isSet: true}
}

func (v NullableGetSitesResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSitesResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
