...
// checks if the NotifiedServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotifiedServer{}
...
type _NotifiedServer NotifiedServer
...
func (o NotifiedServer) MarshalJSON() ([]byte, error) {
...
func (o *NotifiedServer) UnmarshalJSON(data []byte) (err error) {
	...
	varNotifiedServer := _NotifiedServer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNotifiedServer)

	if err != nil {
		return err
	}

	*o = NotifiedServer(varNotifiedServer)

	return err
}

type NullableNotifiedServer struct {
	value *NotifiedServer
	isSet bool
}

func (v NullableNotifiedServer) Get() *NotifiedServer {
	return v.value
}

func (v *NullableNotifiedServer) Set(val *NotifiedServer) {
	v.value = val
	v.isSet = true
}

func (v NullableNotifiedServer) IsSet() bool {
	return v.isSet
}

func (v *NullableNotifiedServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotifiedServer(val *NotifiedServer) *NullableNotifiedServer {
	return &NullableNotifiedServer{value: val, isSet: true}
}

func (v NullableNotifiedServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotifiedServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
