...
// checks if the ConfigSitesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigSitesInner{}
...
func (o *ConfigSitesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varConfigSitesInner := _ConfigSitesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConfigSitesInner)

	if err != nil {
		return err
	}

	*o = ConfigSitesInner(varConfigSitesInner)

	return err
}

type NullableConfigSitesInner struct {
	value *ConfigSitesInner
	isSet bool
}

func (v NullableConfigSitesInner) Get() *ConfigSitesInner {
	return v.value
}

func (v *NullableConfigSitesInner) Set(val *ConfigSitesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigSitesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigSitesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigSitesInner(val *ConfigSitesInner) *NullableConfigSitesInner {
	return &NullableConfigSitesInner{value: val, isSet: true}
}

func (v NullableConfigSitesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigSitesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
