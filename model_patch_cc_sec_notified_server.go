...
// checks if the PatchCcSecNotifiedServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchCcSecNotifiedServer{}
...
func NewPatchCcSecNotifiedServer() *PatchCcSecNotifiedServer {
	this := PatchCcSecNotifiedServer{}
	return &this
}

// NewPatchCcSecNotifiedServerWithDefaults instantiates a new PatchCcSecNotifiedServer object
...
func (o *PatchCcSecNotifiedServer) GetTsigId() int64 {
...
func (o *PatchCcSecNotifiedServer) GetTsigIdOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchCcSecNotifiedServer) HasTsigId() bool {
...
type NullablePatchCcSecNotifiedServer struct {
	value *PatchCcSecNotifiedServer
	isSet bool
}

func (v NullablePatchCcSecNotifiedServer) Get() *PatchCcSecNotifiedServer {
	return v.value
}

func (v *NullablePatchCcSecNotifiedServer) Set(val *PatchCcSecNotifiedServer) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchCcSecNotifiedServer) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchCcSecNotifiedServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchCcSecNotifiedServer(val *PatchCcSecNotifiedServer) *NullablePatchCcSecNotifiedServer {
	return &NullablePatchCcSecNotifiedServer{value: val, isSet: true}
}

func (v NullablePatchCcSecNotifiedServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchCcSecNotifiedServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
