...
// checks if the GetTsigs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTsigs{}

// GetTsigs struct for GetTsigs
type GetTsigs struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string `json:"request_id"`
	Results   []Tsig `json:"results"`
}

type _GetTsigs GetTsigs
...
func (o GetTsigs) MarshalJSON() ([]byte, error) {
...
func (o GetTsigs) ToMap() (map[string]interface{}, error) {
...
func (o *GetTsigs) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTsigs := _GetTsigs{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTsigs)

	if err != nil {
		return err
	}

	*o = GetTsigs(varGetTsigs)

	return err
}

type NullableGetTsigs struct {
	value *GetTsigs
	isSet bool
}

func (v NullableGetTsigs) Get() *GetTsigs {
	return v.value
}

func (v *NullableGetTsigs) Set(val *GetTsigs) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTsigs) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTsigs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTsigs(val *GetTsigs) *NullableGetTsigs {
	return &NullableGetTsigs{value: val, isSet: true}
}

func (v NullableGetTsigs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTsigs) UnmarshalJSON(src []byte) error {
	v.isSet = true
