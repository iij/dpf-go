...
// checks if the GetContractsLogs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetContractsLogs{}

// GetContractsLogs struct for GetContractsLogs
type GetContractsLogs struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string         `json:"request_id"`
	Results   []ContractsLog `json:"results"`
}

type _GetContractsLogs GetContractsLogs
...
func (o GetContractsLogs) MarshalJSON() ([]byte, error) {
...
func (o GetContractsLogs) ToMap() (map[string]interface{}, error) {
...
func (o *GetContractsLogs) UnmarshalJSON(data []byte) (err error) {
	...
	varGetContractsLogs := _GetContractsLogs{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetContractsLogs)

	if err != nil {
		return err
	}

	*o = GetContractsLogs(varGetContractsLogs)

	return err
}

type NullableGetContractsLogs struct {
	value *GetContractsLogs
	isSet bool
}

func (v NullableGetContractsLogs) Get() *GetContractsLogs {
	return v.value
}

func (v *NullableGetContractsLogs) Set(val *GetContractsLogs) {
	v.value = val
	v.isSet = true
}

func (v NullableGetContractsLogs) IsSet() bool {
	return v.isSet
}

func (v *NullableGetContractsLogs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetContractsLogs(val *GetContractsLogs) *NullableGetContractsLogs {
	return &NullableGetContractsLogs{value: val, isSet: true}
}

func (v NullableGetContractsLogs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetContractsLogs) UnmarshalJSON(src []byte) error {
	v.isSet = true
