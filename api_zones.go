...
func (r ApiGetZoneLabelsRequest) Execute() (*GetZoneLabels, *http.Response, error) {
...
// Execute executes the request
//
//	@return GetZoneLabels
func (a *ZonesAPIService) GetZoneLabelsExecute(r ApiGetZoneLabelsRequest) (*GetZoneLabels, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetZoneLabels
	)
...
func (a *ZonesAPIService) GetZoneListExecute(r ApiGetZoneListRequest) (*GetZones, *http.Response, error) {
	...
	if r.keywordsNetwork != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_network[]", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_network[]", t, "form", "multi")
		}
	} else {
		var defaultValue []string = []string{}
		parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_network[]", defaultValue, "form", "multi")
	...
	if r.keywordsZoneProxyEnabled != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_zone_proxy_enabled[]", r.keywordsZoneProxyEnabled, "form", "")
	}
...
func (a *ZonesAPIService) PatchZoneExecute(r ApiPatchZoneRequest) (*AsyncResponse, *http.Response, error) {
	...
	if r.patchZone == nil {
		return localVarReturnValue, nil, reportError("patchZone is required and must be specified")
	}
...
func (a *ZonesAPIService) PatchZoneAtomicChangesExecute(r ApiPatchZoneAtomicChangesRequest) (*AsyncResponse, *http.Response, error) {
	...
	if r.patchZoneAtomicChanges == nil {
		return localVarReturnValue, nil, reportError("patchZoneAtomicChanges is required and must be specified")
	}
...
func (a *ZonesAPIService) PatchZoneChangesExecute(r ApiPatchZoneChangesRequest) (*AsyncResponse, *http.Response, error) {
	...
	if r.patchZoneCommit == nil {
		return localVarReturnValue, nil, reportError("patchZoneCommit is required and must be specified")
	}
...
func (a *ZonesAPIService) PutZoneLabelsExecute(r ApiPutZoneLabelsRequest) (*AsyncResponse, *http.Response, error) {
	...
	if r.zoneLabels == nil {
		return localVarReturnValue, nil, reportError("zoneLabels is required and must be specified")
	}
