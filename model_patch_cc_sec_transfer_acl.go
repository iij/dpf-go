...
// checks if the PatchCcSecTransferAcl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchCcSecTransferAcl{}
...
func (o *PatchCcSecTransferAcl) SetTsigIdNil() {
	o.TsigId.Set(nil)
}
...
type NullablePatchCcSecTransferAcl struct {
	value *PatchCcSecTransferAcl
	isSet bool
}

func (v NullablePatchCcSecTransferAcl) Get() *PatchCcSecTransferAcl {
	return v.value
}

func (v *NullablePatchCcSecTransferAcl) Set(val *PatchCcSecTransferAcl) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchCcSecTransferAcl) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchCcSecTransferAcl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchCcSecTransferAcl(val *PatchCcSecTransferAcl) *NullablePatchCcSecTransferAcl {
	return &NullablePatchCcSecTransferAcl{value: val, isSet: true}
}

func (v NullablePatchCcSecTransferAcl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchCcSecTransferAcl) UnmarshalJSON(src []byte) error {
	v.isSet = true
