...
// checks if the MonitoringStatic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonitoringStatic{}

// MonitoringStatic struct for MonitoringStatic
type MonitoringStatic struct {
...
type _MonitoringStatic MonitoringStatic
...
func (o MonitoringStatic) MarshalJSON() ([]byte, error) {
...
func (o MonitoringStatic) ToMap() (map[string]interface{}, error) {
...
func (o *MonitoringStatic) UnmarshalJSON(data []byte) (err error) {
	...
	varMonitoringStatic := _MonitoringStatic{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMonitoringStatic)

	if err != nil {
		return err
	}

	*o = MonitoringStatic(varMonitoringStatic)

	return err
}

type NullableMonitoringStatic struct {
	value *MonitoringStatic
	isSet bool
}

func (v NullableMonitoringStatic) Get() *MonitoringStatic {
	return v.value
}

func (v *NullableMonitoringStatic) Set(val *MonitoringStatic) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitoringStatic) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitoringStatic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitoringStatic(val *MonitoringStatic) *NullableMonitoringStatic {
	return &NullableMonitoringStatic{value: val, isSet: true}
}

func (v NullableMonitoringStatic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitoringStatic) UnmarshalJSON(src []byte) error {
	v.isSet = true
