...
// checks if the GetCcPrimary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCcPrimary{}

// GetCcPrimary struct for GetCcPrimary
type GetCcPrimary struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string    `json:"request_id"`
	Result    CcPrimary `json:"result"`
}

type _GetCcPrimary GetCcPrimary
...
func (o GetCcPrimary) MarshalJSON() ([]byte, error) {
...
func (o GetCcPrimary) ToMap() (map[string]interface{}, error) {
...
func (o *GetCcPrimary) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCcPrimary := _GetCcPrimary{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCcPrimary)

	if err != nil {
		return err
	}

	*o = GetCcPrimary(varGetCcPrimary)

	return err
}

type NullableGetCcPrimary struct {
	value *GetCcPrimary
	isSet bool
}

func (v NullableGetCcPrimary) Get() *GetCcPrimary {
	return v.value
}

func (v *NullableGetCcPrimary) Set(val *GetCcPrimary) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCcPrimary) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCcPrimary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCcPrimary(val *GetCcPrimary) *NullableGetCcPrimary {
	return &NullableGetCcPrimary{value: val, isSet: true}
}

func (v NullableGetCcPrimary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCcPrimary) UnmarshalJSON(src []byte) error {
	v.isSet = true
