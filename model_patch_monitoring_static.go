...
// checks if the PatchMonitoringStatic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchMonitoringStatic{}
...
func NewPatchMonitoringStatic() *PatchMonitoringStatic {
	this := PatchMonitoringStatic{}
	var description string = ""
	this.Description = &description
	return &this
}

// NewPatchMonitoringStaticWithDefaults instantiates a new PatchMonitoringStatic object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPatchMonitoringStaticWithDefaults() *PatchMonitoringStatic {
	this := PatchMonitoringStatic{}
	var description string = ""
	this.Description = &description
	return &this
...
func (o *PatchMonitoringStatic) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *PatchMonitoringStatic) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *PatchMonitoringStatic) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *PatchMonitoringStatic) GetProps() PatchMonitoringStaticProps {
...
// and a boolean to check if the value has been set.
func (o *PatchMonitoringStatic) GetPropsOk() (*PatchMonitoringStaticProps, bool) {
	if o == nil || IsNil(o.Props) {
		return nil, false
	}
	return o.Props, true
...
func (o *PatchMonitoringStatic) HasProps() bool {
	if o != nil && !IsNil(o.Props) {
		return true
	}
...
func (o *PatchMonitoringStatic) SetProps(v PatchMonitoringStaticProps) {
	o.Props = &v
}

func (o PatchMonitoringStatic) MarshalJSON() ([]byte, error) {
...
type NullablePatchMonitoringStatic struct {
	value *PatchMonitoringStatic
	isSet bool
}

func (v NullablePatchMonitoringStatic) Get() *PatchMonitoringStatic {
	return v.value
}

func (v *NullablePatchMonitoringStatic) Set(val *PatchMonitoringStatic) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchMonitoringStatic) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchMonitoringStatic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchMonitoringStatic(val *PatchMonitoringStatic) *NullablePatchMonitoringStatic {
	return &NullablePatchMonitoringStatic{value: val, isSet: true}
}

func (v NullablePatchMonitoringStatic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchMonitoringStatic) UnmarshalJSON(src []byte) error {
	v.isSet = true
