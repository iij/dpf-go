...
// checks if the Tsig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Tsig{}
...
func (o *Tsig) UnmarshalJSON(data []byte) (err error) {
...
type NullableTsig struct {
	value *Tsig
	isSet bool
}

func (v NullableTsig) Get() *Tsig {
	return v.value
}

func (v *NullableTsig) Set(val *Tsig) {
	v.value = val
	v.isSet = true
}

func (v NullableTsig) IsSet() bool {
	return v.isSet
}

func (v *NullableTsig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTsig(val *Tsig) *NullableTsig {
	return &NullableTsig{value: val, isSet: true}
}

func (v NullableTsig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTsig) UnmarshalJSON(src []byte) error {
	v.isSet = true
