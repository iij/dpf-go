...
// checks if the PostTsig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostTsig{}
...
func (o *PostTsig) UnmarshalJSON(data []byte) (err error) {
	...
	varPostTsig := _PostTsig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostTsig)

	if err != nil {
		return err
	}

	*o = PostTsig(varPostTsig)

	return err
}

type NullablePostTsig struct {
	value *PostTsig
	isSet bool
}

func (v NullablePostTsig) Get() *PostTsig {
	return v.value
}

func (v *NullablePostTsig) Set(val *PostTsig) {
	v.value = val
	v.isSet = true
}

func (v NullablePostTsig) IsSet() bool {
	return v.isSet
}

func (v *NullablePostTsig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostTsig(val *PostTsig) *NullablePostTsig {
	return &NullablePostTsig{value: val, isSet: true}
}

func (v NullablePostTsig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostTsig) UnmarshalJSON(src []byte) error {
	v.isSet = true
