...
// checks if the ZoneProxyHealth type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneProxyHealth{}

// ZoneProxyHealth struct for ZoneProxyHealth
...
// GetTsigName returns the TsigName field value
...
// GetTsigNameOk returns a tuple with the TsigName field value
// and a boolean to check if the value has been set.
func (o *ZoneProxyHealth) GetTsigNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TsigName, true
}

// SetTsigName sets field value
...
func (o *ZoneProxyHealth) UnmarshalJSON(data []byte) (err error) {
	...
	varZoneProxyHealth := _ZoneProxyHealth{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varZoneProxyHealth)

	if err != nil {
		return err
	}

	*o = ZoneProxyHealth(varZoneProxyHealth)

	return err
}

type NullableZoneProxyHealth struct {
	value *ZoneProxyHealth
	isSet bool
}

func (v NullableZoneProxyHealth) Get() *ZoneProxyHealth {
	return v.value
}

func (v *NullableZoneProxyHealth) Set(val *ZoneProxyHealth) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneProxyHealth) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneProxyHealth) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneProxyHealth(val *ZoneProxyHealth) *NullableZoneProxyHealth {
	return &NullableZoneProxyHealth{value: val, isSet: true}
}

func (v NullableZoneProxyHealth) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneProxyHealth) UnmarshalJSON(src []byte) error {
	v.isSet = true
