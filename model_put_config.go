...
// checks if the PutConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutConfig{}
...
func (o *PutConfig) GetMonitorings() []PutConfigMonitoringsInner {
	if o == nil {
		var ret []PutConfigMonitoringsInner
		return ret
	}
...
func (o *PutConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varPutConfig := _PutConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutConfig)

	if err != nil {
		return err
	}

	*o = PutConfig(varPutConfig)

	return err
}

type NullablePutConfig struct {
	value *PutConfig
	isSet bool
}

func (v NullablePutConfig) Get() *PutConfig {
	return v.value
}

func (v *NullablePutConfig) Set(val *PutConfig) {
	v.value = val
	v.isSet = true
}

func (v NullablePutConfig) IsSet() bool {
	return v.isSet
}

func (v *NullablePutConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutConfig(val *PutConfig) *NullablePutConfig {
	return &NullablePutConfig{value: val, isSet: true}
}

func (v NullablePutConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
