...
// checks if the GetDsRecords type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDsRecords{}

// GetDsRecords struct for GetDsRecords
type GetDsRecords struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string     `json:"request_id"`
	Results   []DsRecord `json:"results"`
}

type _GetDsRecords GetDsRecords
...
func (o GetDsRecords) MarshalJSON() ([]byte, error) {
...
func (o GetDsRecords) ToMap() (map[string]interface{}, error) {
...
func (o *GetDsRecords) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDsRecords := _GetDsRecords{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetDsRecords)

	if err != nil {
		return err
	}

	*o = GetDsRecords(varGetDsRecords)

	return err
}

type NullableGetDsRecords struct {
	value *GetDsRecords
	isSet bool
}

func (v NullableGetDsRecords) Get() *GetDsRecords {
	return v.value
}

func (v *NullableGetDsRecords) Set(val *GetDsRecords) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDsRecords) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDsRecords) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDsRecords(val *GetDsRecords) *NullableGetDsRecords {
	return &NullableGetDsRecords{value: val, isSet: true}
}

func (v NullableGetDsRecords) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDsRecords) UnmarshalJSON(src []byte) error {
	v.isSet = true
