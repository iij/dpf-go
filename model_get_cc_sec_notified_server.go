...
// checks if the GetCcSecNotifiedServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCcSecNotifiedServer{}

// GetCcSecNotifiedServer struct for GetCcSecNotifiedServer
type GetCcSecNotifiedServer struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string         `json:"request_id"`
	Result    NotifiedServer `json:"result"`
}

type _GetCcSecNotifiedServer GetCcSecNotifiedServer
...
func (o GetCcSecNotifiedServer) MarshalJSON() ([]byte, error) {
...
func (o GetCcSecNotifiedServer) ToMap() (map[string]interface{}, error) {
...
func (o *GetCcSecNotifiedServer) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCcSecNotifiedServer := _GetCcSecNotifiedServer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCcSecNotifiedServer)

	if err != nil {
		return err
	}

	*o = GetCcSecNotifiedServer(varGetCcSecNotifiedServer)

	return err
}

type NullableGetCcSecNotifiedServer struct {
	value *GetCcSecNotifiedServer
	isSet bool
}

func (v NullableGetCcSecNotifiedServer) Get() *GetCcSecNotifiedServer {
	return v.value
}

func (v *NullableGetCcSecNotifiedServer) Set(val *GetCcSecNotifiedServer) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCcSecNotifiedServer) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCcSecNotifiedServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCcSecNotifiedServer(val *GetCcSecNotifiedServer) *NullableGetCcSecNotifiedServer {
	return &NullableGetCcSecNotifiedServer{value: val, isSet: true}
}

func (v NullableGetCcSecNotifiedServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCcSecNotifiedServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
