...
// checks if the ConfigRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigRulesInner{}

// ConfigRulesInner struct for ConfigRulesInner
type ConfigRulesInner struct {
...
type _ConfigRulesInner ConfigRulesInner
...
func (o ConfigRulesInner) MarshalJSON() ([]byte, error) {
...
func (o ConfigRulesInner) ToMap() (map[string]interface{}, error) {
...
func (o *ConfigRulesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varConfigRulesInner := _ConfigRulesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConfigRulesInner)

	if err != nil {
		return err
	}

	*o = ConfigRulesInner(varConfigRulesInner)

	return err
}

type NullableConfigRulesInner struct {
	value *ConfigRulesInner
	isSet bool
}

func (v NullableConfigRulesInner) Get() *ConfigRulesInner {
	return v.value
}

func (v *NullableConfigRulesInner) Set(val *ConfigRulesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigRulesInner(val *ConfigRulesInner) *NullableConfigRulesInner {
	return &NullableConfigRulesInner{value: val, isSet: true}
}

func (v NullableConfigRulesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigRulesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
