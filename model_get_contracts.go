...
// checks if the GetContracts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetContracts{}

// GetContracts struct for GetContracts
...
type _GetContracts GetContracts
...
func (o GetContracts) MarshalJSON() ([]byte, error) {
...
func (o GetContracts) ToMap() (map[string]interface{}, error) {
...
func (o *GetContracts) UnmarshalJSON(data []byte) (err error) {
	...
	varGetContracts := _GetContracts{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetContracts)

	if err != nil {
		return err
	}

	*o = GetContracts(varGetContracts)

	return err
}

type NullableGetContracts struct {
	value *GetContracts
	isSet bool
}

func (v NullableGetContracts) Get() *GetContracts {
	return v.value
}

func (v *NullableGetContracts) Set(val *GetContracts) {
	v.value = val
	v.isSet = true
}

func (v NullableGetContracts) IsSet() bool {
	return v.isSet
}

func (v *NullableGetContracts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetContracts(val *GetContracts) *NullableGetContracts {
	return &NullableGetContracts{value: val, isSet: true}
}

func (v NullableGetContracts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetContracts) UnmarshalJSON(src []byte) error {
	v.isSet = true
