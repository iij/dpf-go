...
// checks if the PatchCcPrimary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchCcPrimary{}
...
// SetEnabled gets a reference to the given CcPrimaryEnabled and assigns it to the Enabled field.
...
type NullablePatchCcPrimary struct {
	value *PatchCcPrimary
	isSet bool
}

func (v NullablePatchCcPrimary) Get() *PatchCcPrimary {
	return v.value
}

func (v *NullablePatchCcPrimary) Set(val *PatchCcPrimary) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchCcPrimary) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchCcPrimary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchCcPrimary(val *PatchCcPrimary) *NullablePatchCcPrimary {
	return &NullablePatchCcPrimary{value: val, isSet: true}
}

func (v NullablePatchCcPrimary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchCcPrimary) UnmarshalJSON(src []byte) error {
	v.isSet = true
