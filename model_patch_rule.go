...
// checks if the PatchRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchRule{}

// PatchRule struct for PatchRule
...
func (o PatchRule) MarshalJSON() ([]byte, error) {
...
func (o PatchRule) ToMap() (map[string]interface{}, error) {
...
type NullablePatchRule struct {
	value *PatchRule
	isSet bool
}

func (v NullablePatchRule) Get() *PatchRule {
	return v.value
}

func (v *NullablePatchRule) Set(val *PatchRule) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchRule) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchRule(val *PatchRule) *NullablePatchRule {
	return &NullablePatchRule{value: val, isSet: true}
}

func (v NullablePatchRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
