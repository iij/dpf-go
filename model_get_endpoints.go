...
// checks if the GetEndpoints type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetEndpoints{}

// GetEndpoints struct for GetEndpoints
type GetEndpoints struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string                     `json:"request_id"`
	Results   []GetEndpointsResultsInner `json:"results"`
}

type _GetEndpoints GetEndpoints

// NewGetEndpoints instantiates a new GetEndpoints object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetEndpoints(requestId string, results []GetEndpointsResultsInner) *GetEndpoints {
	this := GetEndpoints{}
...
func (o *GetEndpoints) GetRequestId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GetEndpoints) GetRequestIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetEndpoints) SetRequestId(v string) {
	o.RequestId = v
}

// GetResults returns the Results field value
func (o *GetEndpoints) GetResults() []GetEndpointsResultsInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *GetEndpoints) GetResultsOk() ([]GetEndpointsResultsInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetEndpoints) SetResults(v []GetEndpointsResultsInner) {
	o.Results = v
}
...
func (o GetEndpoints) ToMap() (map[string]interface{}, error) {
...
func (o *GetEndpoints) UnmarshalJSON(data []byte) (err error) {
	...
	varGetEndpoints := _GetEndpoints{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetEndpoints)

	if err != nil {
		return err
	}

	*o = GetEndpoints(varGetEndpoints)
