...
type Sites struct {
	Sites []SitesSitesInner `json:"sites,omitempty"`
}
...
func (o *Sites) GetSites() []SitesSitesInner {
...
func (o *Sites) GetSitesOk() ([]SitesSitesInner, bool) {
	if o == nil || IsNil(o.Sites) {
		return nil, false
	}
	return o.Sites, true
...
// SetSites gets a reference to the given []SitesSitesInner and assigns it to the Sites field.
func (o *Sites) SetSites(v []SitesSitesInner) {
	o.Sites = v
}
