...
// checks if the EndpointMonitoringsMonitoringsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EndpointMonitoringsMonitoringsInner{}
...
type _EndpointMonitoringsMonitoringsInner EndpointMonitoringsMonitoringsInner
...
func (o EndpointMonitoringsMonitoringsInner) MarshalJSON() ([]byte, error) {
...
func (o *EndpointMonitoringsMonitoringsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varEndpointMonitoringsMonitoringsInner := _EndpointMonitoringsMonitoringsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEndpointMonitoringsMonitoringsInner)

	if err != nil {
		return err
	}

	*o = EndpointMonitoringsMonitoringsInner(varEndpointMonitoringsMonitoringsInner)

	return err
}

type NullableEndpointMonitoringsMonitoringsInner struct {
	value *EndpointMonitoringsMonitoringsInner
	isSet bool
}

func (v NullableEndpointMonitoringsMonitoringsInner) Get() *EndpointMonitoringsMonitoringsInner {
	return v.value
}

func (v *NullableEndpointMonitoringsMonitoringsInner) Set(val *EndpointMonitoringsMonitoringsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableEndpointMonitoringsMonitoringsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableEndpointMonitoringsMonitoringsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEndpointMonitoringsMonitoringsInner(val *EndpointMonitoringsMonitoringsInner) *NullableEndpointMonitoringsMonitoringsInner {
	return &NullableEndpointMonitoringsMonitoringsInner{value: val, isSet: true}
}

func (v NullableEndpointMonitoringsMonitoringsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEndpointMonitoringsMonitoringsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
