...
// checks if the PutRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutRecord{}
...
func (o *PutRecord) UnmarshalJSON(data []byte) (err error) {
	...
	varPutRecord := _PutRecord{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutRecord)

	if err != nil {
		return err
	}

	*o = PutRecord(varPutRecord)

	return err
}

type NullablePutRecord struct {
	value *PutRecord
	isSet bool
}

func (v NullablePutRecord) Get() *PutRecord {
	return v.value
}

func (v *NullablePutRecord) Set(val *PutRecord) {
	v.value = val
	v.isSet = true
}

func (v NullablePutRecord) IsSet() bool {
	return v.isSet
}

func (v *NullablePutRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutRecord(val *PutRecord) *NullablePutRecord {
	return &NullablePutRecord{value: val, isSet: true}
}

func (v NullablePutRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
