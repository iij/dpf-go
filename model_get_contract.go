...
// checks if the GetContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetContract{}

// GetContract struct for GetContract
...
func (o GetContract) MarshalJSON() ([]byte, error) {
...
func (o GetContract) ToMap() (map[string]interface{}, error) {
...
func (o *GetContract) UnmarshalJSON(data []byte) (err error) {
	...
	varGetContract := _GetContract{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetContract)

	if err != nil {
		return err
	}

	*o = GetContract(varGetContract)

	return err
}

type NullableGetContract struct {
	value *GetContract
	isSet bool
}

func (v NullableGetContract) Get() *GetContract {
	return v.value
}

func (v *NullableGetContract) Set(val *GetContract) {
	v.value = val
	v.isSet = true
}

func (v NullableGetContract) IsSet() bool {
	return v.isSet
}

func (v *NullableGetContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetContract(val *GetContract) *NullableGetContract {
	return &NullableGetContract{value: val, isSet: true}
}

func (v NullableGetContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
