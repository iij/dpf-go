...
func NewErrorDetail(code string, attribute string) *ErrorDetail {
	this := ErrorDetail{}
	this.Code = code
...
func (o *ErrorDetail) GetAttribute() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ErrorDetail) GetAttributeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ErrorDetail) SetAttribute(v string) {
	o.Attribute = v
}
