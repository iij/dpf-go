...
// checks if the PostCommonConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCommonConfig{}
...
// NewPostCommonConfig instantiates a new PostCommonConfig object
...
// NewPostCommonConfigWithDefaults instantiates a new PostCommonConfig object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPostCommonConfigWithDefaults() *PostCommonConfig {
	this := PostCommonConfig{}
	var description string = ""
	this.Description = &description
	return &this
...
func (o *PostCommonConfig) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *PostCommonConfig) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *PostCommonConfig) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *PostCommonConfig) SetDescription(v string) {
	o.Description = &v
}
...
func (o *PostCommonConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCommonConfig := _PostCommonConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCommonConfig)

	if err != nil {
		return err
	}

	*o = PostCommonConfig(varPostCommonConfig)

	return err
}

type NullablePostCommonConfig struct {
	value *PostCommonConfig
	isSet bool
}

func (v NullablePostCommonConfig) Get() *PostCommonConfig {
	return v.value
}

func (v *NullablePostCommonConfig) Set(val *PostCommonConfig) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCommonConfig) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCommonConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCommonConfig(val *PostCommonConfig) *NullablePostCommonConfig {
	return &NullablePostCommonConfig{value: val, isSet: true}
}

func (v NullablePostCommonConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCommonConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
