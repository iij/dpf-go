...
// checks if the GetMonitorings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMonitorings{}

// GetMonitorings struct for GetMonitorings
type GetMonitorings struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string                `json:"request_id"`
	Results   []GetMonitoringResult `json:"results"`
}

type _GetMonitorings GetMonitorings
...
func (o GetMonitorings) MarshalJSON() ([]byte, error) {
...
func (o GetMonitorings) ToMap() (map[string]interface{}, error) {
...
func (o *GetMonitorings) UnmarshalJSON(data []byte) (err error) {
	...
	varGetMonitorings := _GetMonitorings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetMonitorings)

	if err != nil {
		return err
	}

	*o = GetMonitorings(varGetMonitorings)

	return err
}

type NullableGetMonitorings struct {
	value *GetMonitorings
	isSet bool
}

func (v NullableGetMonitorings) Get() *GetMonitorings {
	return v.value
}

func (v *NullableGetMonitorings) Set(val *GetMonitorings) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMonitorings) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMonitorings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMonitorings(val *GetMonitorings) *NullableGetMonitorings {
	return &NullableGetMonitorings{value: val, isSet: true}
}

func (v NullableGetMonitorings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMonitorings) UnmarshalJSON(src []byte) error {
	v.isSet = true
