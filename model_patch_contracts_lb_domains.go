...
// checks if the PatchContractsLbDomains type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchContractsLbDomains{}

// PatchContractsLbDomains struct for PatchContractsLbDomains
type PatchContractsLbDomains struct {
	CommonConfigId int64 `json:"common_config_id"`
	// GET lb_domains Schemaにおける id の配列
	LbDomainIds []string `json:"lb_domain_ids"`
}

type _PatchContractsLbDomains PatchContractsLbDomains
...
func NewPatchContractsLbDomains(commonConfigId int64, lbDomainIds []string) *PatchContractsLbDomains {
	this := PatchContractsLbDomains{}
	this.CommonConfigId = commonConfigId
	this.LbDomainIds = lbDomainIds
	return &this
}
...
// GetLbDomainIds returns the LbDomainIds field value
func (o *PatchContractsLbDomains) GetLbDomainIds() []string {
	...
	return o.LbDomainIds
}

// GetLbDomainIdsOk returns a tuple with the LbDomainIds field value
// and a boolean to check if the value has been set.
func (o *PatchContractsLbDomains) GetLbDomainIdsOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.LbDomainIds, true
}

// SetLbDomainIds sets field value
func (o *PatchContractsLbDomains) SetLbDomainIds(v []string) {
	o.LbDomainIds = v
}

func (o PatchContractsLbDomains) MarshalJSON() ([]byte, error) {
...
func (o PatchContractsLbDomains) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["common_config_id"] = o.CommonConfigId
	toSerialize["lb_domain_ids"] = o.LbDomainIds
	return toSerialize, nil
}

func (o *PatchContractsLbDomains) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchContractsLbDomains := _PatchContractsLbDomains{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPatchContractsLbDomains)

	if err != nil {
		return err
	}

	*o = PatchContractsLbDomains(varPatchContractsLbDomains)

	return err
}

type NullablePatchContractsLbDomains struct {
	value *PatchContractsLbDomains
	isSet bool
}

func (v NullablePatchContractsLbDomains) Get() *PatchContractsLbDomains {
	return v.value
}

func (v *NullablePatchContractsLbDomains) Set(val *PatchContractsLbDomains) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchContractsLbDomains) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchContractsLbDomains) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchContractsLbDomains(val *PatchContractsLbDomains) *NullablePatchContractsLbDomains {
	return &NullablePatchContractsLbDomains{value: val, isSet: true}
}

func (v NullablePatchContractsLbDomains) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchContractsLbDomains) UnmarshalJSON(src []byte) error {
	v.isSet = true
