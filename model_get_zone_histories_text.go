...
// checks if the GetZoneHistoriesText type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZoneHistoriesText{}

// GetZoneHistoriesText struct for GetZoneHistoriesText
type GetZoneHistoriesText struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string          `json:"request_id"`
	Result    ZoneHistoryText `json:"result"`
}

type _GetZoneHistoriesText GetZoneHistoriesText
...
func (o GetZoneHistoriesText) MarshalJSON() ([]byte, error) {
...
func (o GetZoneHistoriesText) ToMap() (map[string]interface{}, error) {
...
func (o *GetZoneHistoriesText) UnmarshalJSON(data []byte) (err error) {
	...
	varGetZoneHistoriesText := _GetZoneHistoriesText{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetZoneHistoriesText)

	if err != nil {
		return err
	}

	*o = GetZoneHistoriesText(varGetZoneHistoriesText)

	return err
}

type NullableGetZoneHistoriesText struct {
	value *GetZoneHistoriesText
	isSet bool
}

func (v NullableGetZoneHistoriesText) Get() *GetZoneHistoriesText {
	return v.value
}

func (v *NullableGetZoneHistoriesText) Set(val *GetZoneHistoriesText) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZoneHistoriesText) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZoneHistoriesText) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZoneHistoriesText(val *GetZoneHistoriesText) *NullableGetZoneHistoriesText {
	return &NullableGetZoneHistoriesText{value: val, isSet: true}
}

func (v NullableGetZoneHistoriesText) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZoneHistoriesText) UnmarshalJSON(src []byte) error {
	v.isSet = true
