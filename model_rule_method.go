...
// checks if the RuleMethod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleMethod{}
...
func (o *RuleMethod) UnmarshalJSON(data []byte) (err error) {
	...
	varRuleMethod := _RuleMethod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRuleMethod)

	if err != nil {
		return err
	}

	*o = RuleMethod(varRuleMethod)

	return err
}

type NullableRuleMethod struct {
	value *RuleMethod
	isSet bool
}

func (v NullableRuleMethod) Get() *RuleMethod {
	return v.value
}

func (v *NullableRuleMethod) Set(val *RuleMethod) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleMethod) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleMethod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleMethod(val *RuleMethod) *NullableRuleMethod {
	return &NullableRuleMethod{value: val, isSet: true}
}

func (v NullableRuleMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleMethod) UnmarshalJSON(src []byte) error {
	v.isSet = true
