...
// checks if the GetZones type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZones{}

// GetZones struct for GetZones
...
func (o GetZones) MarshalJSON() ([]byte, error) {
...
func (o GetZones) ToMap() (map[string]interface{}, error) {
...
func (o *GetZones) UnmarshalJSON(data []byte) (err error) {
	...
	varGetZones := _GetZones{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetZones)

	if err != nil {
		return err
	}

	*o = GetZones(varGetZones)

	return err
}

type NullableGetZones struct {
	value *GetZones
	isSet bool
}

func (v NullableGetZones) Get() *GetZones {
	return v.value
}

func (v *NullableGetZones) Set(val *GetZones) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZones) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZones) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZones(val *GetZones) *NullableGetZones {
	return &NullableGetZones{value: val, isSet: true}
}

func (v NullableGetZones) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZones) UnmarshalJSON(src []byte) error {
	v.isSet = true
