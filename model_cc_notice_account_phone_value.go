...
// CcNoticeAccountPhoneValue - struct for CcNoticeAccountPhoneValue
type CcNoticeAccountPhoneValue struct {
	CcNoticeAccountEmptyPhone *CcNoticeAccountEmptyPhone
	CcNoticeAccountPhone      *CcNoticeAccountPhone
}

// CcNoticeAccountEmptyPhoneAsCcNoticeAccountPhoneValue is a convenience function that returns CcNoticeAccountEmptyPhone wrapped in CcNoticeAccountPhoneValue
func CcNoticeAccountEmptyPhoneAsCcNoticeAccountPhoneValue(v *CcNoticeAccountEmptyPhone) CcNoticeAccountPhoneValue {
	return CcNoticeAccountPhoneValue{
		CcNoticeAccountEmptyPhone: v,
	}
}

// CcNoticeAccountPhoneAsCcNoticeAccountPhoneValue is a convenience function that returns CcNoticeAccountPhone wrapped in CcNoticeAccountPhoneValue
func CcNoticeAccountPhoneAsCcNoticeAccountPhoneValue(v *CcNoticeAccountPhone) CcNoticeAccountPhoneValue {
	return CcNoticeAccountPhoneValue{
...
func (dst *CcNoticeAccountPhoneValue) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if err == nil {
		...
		if string(jsonCcNoticeAccountEmptyPhone) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.CcNoticeAccountEmptyPhone); err != nil {
				dst.CcNoticeAccountEmptyPhone = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonCcNoticeAccountPhone) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.CcNoticeAccountPhone); err != nil {
				dst.CcNoticeAccountPhone = nil
			} else {
				match++
			}
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(CcNoticeAccountPhoneValue)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(CcNoticeAccountPhoneValue)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src CcNoticeAccountPhoneValue) MarshalJSON() ([]byte, error) {
...
func (obj *CcNoticeAccountPhoneValue) GetActualInstance() interface{} {
	if obj == nil {
		return nil
	}
...
func (obj CcNoticeAccountPhoneValue) GetActualInstanceValue() interface{} {
	if obj.CcNoticeAccountEmptyPhone != nil {
		return *obj.CcNoticeAccountEmptyPhone
	}
...
type NullableCcNoticeAccountPhoneValue struct {
	value *CcNoticeAccountPhoneValue
	isSet bool
}

func (v NullableCcNoticeAccountPhoneValue) Get() *CcNoticeAccountPhoneValue {
	return v.value
}

func (v *NullableCcNoticeAccountPhoneValue) Set(val *CcNoticeAccountPhoneValue) {
	v.value = val
	v.isSet = true
}

func (v NullableCcNoticeAccountPhoneValue) IsSet() bool {
	return v.isSet
}

func (v *NullableCcNoticeAccountPhoneValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcNoticeAccountPhoneValue(val *CcNoticeAccountPhoneValue) *NullableCcNoticeAccountPhoneValue {
	return &NullableCcNoticeAccountPhoneValue{value: val, isSet: true}
}

func (v NullableCcNoticeAccountPhoneValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCcNoticeAccountPhoneValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
