...
// checks if the PatchContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchContract{}
...
type NullablePatchContract struct {
	value *PatchContract
	isSet bool
}

func (v NullablePatchContract) Get() *PatchContract {
	return v.value
}

func (v *NullablePatchContract) Set(val *PatchContract) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchContract) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchContract(val *PatchContract) *NullablePatchContract {
	return &NullablePatchContract{value: val, isSet: true}
}

func (v NullablePatchContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
