...
// checks if the PutConfigRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutConfigRulesInner{}

// PutConfigRulesInner struct for PutConfigRulesInner
type PutConfigRulesInner struct {
...
type _PutConfigRulesInner PutConfigRulesInner
...
func (o PutConfigRulesInner) MarshalJSON() ([]byte, error) {
...
func (o PutConfigRulesInner) ToMap() (map[string]interface{}, error) {
...
func (o *PutConfigRulesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varPutConfigRulesInner := _PutConfigRulesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutConfigRulesInner)

	if err != nil {
		return err
	}

	*o = PutConfigRulesInner(varPutConfigRulesInner)

	return err
}

type NullablePutConfigRulesInner struct {
	value *PutConfigRulesInner
	isSet bool
}

func (v NullablePutConfigRulesInner) Get() *PutConfigRulesInner {
	return v.value
}

func (v *NullablePutConfigRulesInner) Set(val *PutConfigRulesInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePutConfigRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePutConfigRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutConfigRulesInner(val *PutConfigRulesInner) *NullablePutConfigRulesInner {
	return &NullablePutConfigRulesInner{value: val, isSet: true}
}

func (v NullablePutConfigRulesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutConfigRulesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
