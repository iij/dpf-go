...
// checks if the CcNoticeAccountPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CcNoticeAccountPhone{}

// CcNoticeAccountPhone struct for CcNoticeAccountPhone
type CcNoticeAccountPhone struct {
	// 国番号（number指定時必須）
...
func (o CcNoticeAccountPhone) MarshalJSON() ([]byte, error) {
...
func (o CcNoticeAccountPhone) ToMap() (map[string]interface{}, error) {
...
type NullableCcNoticeAccountPhone struct {
	value *CcNoticeAccountPhone
	isSet bool
}

func (v NullableCcNoticeAccountPhone) Get() *CcNoticeAccountPhone {
	return v.value
}

func (v *NullableCcNoticeAccountPhone) Set(val *CcNoticeAccountPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableCcNoticeAccountPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableCcNoticeAccountPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcNoticeAccountPhone(val *CcNoticeAccountPhone) *NullableCcNoticeAccountPhone {
	return &NullableCcNoticeAccountPhone{value: val, isSet: true}
}

func (v NullableCcNoticeAccountPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCcNoticeAccountPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
