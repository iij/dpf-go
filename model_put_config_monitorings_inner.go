...
// checks if the PutConfigMonitoringsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutConfigMonitoringsInner{}

// PutConfigMonitoringsInner struct for PutConfigMonitoringsInner
type PutConfigMonitoringsInner struct {
	...
	Mtype MonitoringMtype `json:"mtype"`
	// コメント
	Description string                         `json:"description"`
	Props       PutConfigMonitoringsInnerProps `json:"props"`
}

type _PutConfigMonitoringsInner PutConfigMonitoringsInner
...
func NewPutConfigMonitoringsInner(resourceName string, name string, mtype MonitoringMtype, description string, props PutConfigMonitoringsInnerProps) *PutConfigMonitoringsInner {
	this := PutConfigMonitoringsInner{}
...
func (o *PutConfigMonitoringsInner) GetProps() PutConfigMonitoringsInnerProps {
	if o == nil {
		var ret PutConfigMonitoringsInnerProps
		return ret
	}
...
func (o PutConfigMonitoringsInner) MarshalJSON() ([]byte, error) {
...
func (o PutConfigMonitoringsInner) ToMap() (map[string]interface{}, error) {
...
func (o *PutConfigMonitoringsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varPutConfigMonitoringsInner := _PutConfigMonitoringsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutConfigMonitoringsInner)

	if err != nil {
		return err
	}

	*o = PutConfigMonitoringsInner(varPutConfigMonitoringsInner)

	return err
}

type NullablePutConfigMonitoringsInner struct {
	value *PutConfigMonitoringsInner
	isSet bool
}

func (v NullablePutConfigMonitoringsInner) Get() *PutConfigMonitoringsInner {
	return v.value
}

func (v *NullablePutConfigMonitoringsInner) Set(val *PutConfigMonitoringsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePutConfigMonitoringsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePutConfigMonitoringsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutConfigMonitoringsInner(val *PutConfigMonitoringsInner) *NullablePutConfigMonitoringsInner {
	return &NullablePutConfigMonitoringsInner{value: val, isSet: true}
}

func (v NullablePutConfigMonitoringsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutConfigMonitoringsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
