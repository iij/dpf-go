...
// checks if the GetTsig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTsig{}

// GetTsig struct for GetTsig
type GetTsig struct {
	// 処理の問い合わせの際のキーになる文字列
...
func (o GetTsig) MarshalJSON() ([]byte, error) {
...
func (o GetTsig) ToMap() (map[string]interface{}, error) {
...
func (o *GetTsig) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varGetTsig)

	if err != nil {
		return err
	}

	*o = GetTsig(varGetTsig)

	return err
}

type NullableGetTsig struct {
	value *GetTsig
	isSet bool
}

func (v NullableGetTsig) Get() *GetTsig {
	return v.value
}

func (v *NullableGetTsig) Set(val *GetTsig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTsig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTsig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTsig(val *GetTsig) *NullableGetTsig {
	return &NullableGetTsig{value: val, isSet: true}
}

func (v NullableGetTsig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTsig) UnmarshalJSON(src []byte) error {
	v.isSet = true
