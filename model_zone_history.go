...
// checks if the ZoneHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneHistory{}
...
func (o ZoneHistory) MarshalJSON() ([]byte, error) {
...
func (o *ZoneHistory) UnmarshalJSON(data []byte) (err error) {
	...
	varZoneHistory := _ZoneHistory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varZoneHistory)

	if err != nil {
		return err
	}

	*o = ZoneHistory(varZoneHistory)

	return err
}

type NullableZoneHistory struct {
	value *ZoneHistory
	isSet bool
}

func (v NullableZoneHistory) Get() *ZoneHistory {
	return v.value
}

func (v *NullableZoneHistory) Set(val *ZoneHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneHistory(val *ZoneHistory) *NullableZoneHistory {
	return &NullableZoneHistory{value: val, isSet: true}
}

func (v NullableZoneHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
