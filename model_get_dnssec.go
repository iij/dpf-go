...
// checks if the GetDnssec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDnssec{}

// GetDnssec struct for GetDnssec
...
func (o GetDnssec) MarshalJSON() ([]byte, error) {
...
func (o GetDnssec) ToMap() (map[string]interface{}, error) {
...
func (o *GetDnssec) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDnssec := _GetDnssec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetDnssec)

	if err != nil {
		return err
	}

	*o = GetDnssec(varGetDnssec)

	return err
}

type NullableGetDnssec struct {
	value *GetDnssec
	isSet bool
}

func (v NullableGetDnssec) Get() *GetDnssec {
	return v.value
}

func (v *NullableGetDnssec) Set(val *GetDnssec) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDnssec) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDnssec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDnssec(val *GetDnssec) *NullableGetDnssec {
	return &NullableGetDnssec{value: val, isSet: true}
}

func (v NullableGetDnssec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDnssec) UnmarshalJSON(src []byte) error {
	v.isSet = true
