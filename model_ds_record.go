...
// checks if the DsRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DsRecord{}

// DsRecord struct for DsRecord
type DsRecord struct {
	Rrset       string    `json:"rrset"`
	TransitedAt time.Time `json:"transited_at"`
}

type _DsRecord DsRecord
...
// GetTransitedAt returns the TransitedAt field value
func (o *DsRecord) GetTransitedAt() time.Time {
	...
	return o.TransitedAt
}

// GetTransitedAtOk returns a tuple with the TransitedAt field value
// and a boolean to check if the value has been set.
func (o *DsRecord) GetTransitedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TransitedAt, true
}

// SetTransitedAt sets field value
func (o *DsRecord) SetTransitedAt(v time.Time) {
	o.TransitedAt = v
}

func (o DsRecord) MarshalJSON() ([]byte, error) {
...
func (o DsRecord) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["rrset"] = o.Rrset
	toSerialize["transited_at"] = o.TransitedAt
	return toSerialize, nil
}

func (o *DsRecord) UnmarshalJSON(data []byte) (err error) {
	...
	varDsRecord := _DsRecord{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDsRecord)

	if err != nil {
		return err
	}

	*o = DsRecord(varDsRecord)

	return err
}

type NullableDsRecord struct {
	value *DsRecord
	isSet bool
}

func (v NullableDsRecord) Get() *DsRecord {
	return v.value
}

func (v *NullableDsRecord) Set(val *DsRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableDsRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableDsRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDsRecord(val *DsRecord) *NullableDsRecord {
	return &NullableDsRecord{value: val, isSet: true}
}

func (v NullableDsRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDsRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
