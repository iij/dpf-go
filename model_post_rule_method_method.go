...
// checks if the PostRuleMethodMethod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostRuleMethodMethod{}
...
type _PostRuleMethodMethod PostRuleMethodMethod
...
func (o PostRuleMethodMethod) MarshalJSON() ([]byte, error) {
...
func (o *PostRuleMethodMethod) UnmarshalJSON(data []byte) (err error) {
	...
	varPostRuleMethodMethod := _PostRuleMethodMethod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostRuleMethodMethod)

	if err != nil {
		return err
	}

	*o = PostRuleMethodMethod(varPostRuleMethodMethod)

	return err
}

type NullablePostRuleMethodMethod struct {
	value *PostRuleMethodMethod
	isSet bool
}

func (v NullablePostRuleMethodMethod) Get() *PostRuleMethodMethod {
	return v.value
}

func (v *NullablePostRuleMethodMethod) Set(val *PostRuleMethodMethod) {
	v.value = val
	v.isSet = true
}

func (v NullablePostRuleMethodMethod) IsSet() bool {
	return v.isSet
}

func (v *NullablePostRuleMethodMethod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostRuleMethodMethod(val *PostRuleMethodMethod) *NullablePostRuleMethodMethod {
	return &NullablePostRuleMethodMethod{value: val, isSet: true}
}

func (v NullablePostRuleMethodMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostRuleMethodMethod) UnmarshalJSON(src []byte) error {
	v.isSet = true
