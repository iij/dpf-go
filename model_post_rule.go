...
// checks if the PostRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostRule{}
...
func (o *PostRule) UnmarshalJSON(data []byte) (err error) {
	...
	varPostRule := _PostRule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostRule)

	if err != nil {
		return err
	}

	*o = PostRule(varPostRule)

	return err
}

type NullablePostRule struct {
	value *PostRule
	isSet bool
}

func (v NullablePostRule) Get() *PostRule {
	return v.value
}

func (v *NullablePostRule) Set(val *PostRule) {
	v.value = val
	v.isSet = true
}

func (v NullablePostRule) IsSet() bool {
	return v.isSet
}

func (v *NullablePostRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostRule(val *PostRule) *NullablePostRule {
	return &NullablePostRule{value: val, isSet: true}
}

func (v NullablePostRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
