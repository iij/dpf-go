...
// checks if the PostRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostRecord{}

// PostRecord struct for PostRecord
type PostRecord struct {
	// name
	Name string `json:"name"`
	// TTL
	Ttl    NullableInt32           `json:"ttl,omitempty"`
	Rrtype RecordsRrtypeWithoutSoa `json:"rrtype"`
	// レコードの値
...
func (o *PostRecord) GetRrtype() RecordsRrtypeWithoutSoa {
	if o == nil {
		var ret RecordsRrtypeWithoutSoa
		return ret
	}
...
func (o PostRecord) MarshalJSON() ([]byte, error) {
...
func (o PostRecord) ToMap() (map[string]interface{}, error) {
...
func (o *PostRecord) UnmarshalJSON(data []byte) (err error) {
	...
	varPostRecord := _PostRecord{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostRecord)

	if err != nil {
		return err
	}

	*o = PostRecord(varPostRecord)

	return err
}

type NullablePostRecord struct {
	value *PostRecord
	isSet bool
}

func (v NullablePostRecord) Get() *PostRecord {
	return v.value
}

func (v *NullablePostRecord) Set(val *PostRecord) {
	v.value = val
	v.isSet = true
}

func (v NullablePostRecord) IsSet() bool {
	return v.isSet
}

func (v *NullablePostRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostRecord(val *PostRecord) *NullablePostRecord {
	return &NullablePostRecord{value: val, isSet: true}
}

func (v NullablePostRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
