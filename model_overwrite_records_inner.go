...
// checks if the OverwriteRecordsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OverwriteRecordsInner{}
...
func (o *OverwriteRecordsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varOverwriteRecordsInner := _OverwriteRecordsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOverwriteRecordsInner)

	if err != nil {
		return err
	}

	*o = OverwriteRecordsInner(varOverwriteRecordsInner)

	return err
}

type NullableOverwriteRecordsInner struct {
	value *OverwriteRecordsInner
	isSet bool
}

func (v NullableOverwriteRecordsInner) Get() *OverwriteRecordsInner {
	return v.value
}

func (v *NullableOverwriteRecordsInner) Set(val *OverwriteRecordsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOverwriteRecordsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOverwriteRecordsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOverwriteRecordsInner(val *OverwriteRecordsInner) *NullableOverwriteRecordsInner {
	return &NullableOverwriteRecordsInner{value: val, isSet: true}
}

func (v NullableOverwriteRecordsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOverwriteRecordsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
