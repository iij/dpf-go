...
// QpsAPIService QpsAPI service
type QpsAPIService service

type ApiGetQpsHistoriesRequest struct {
	ctx        context.Context
	ApiService *QpsAPIService
	contractId string
}

func (r ApiGetQpsHistoriesRequest) Execute() (*GetQpsHistories, *http.Response, error) {
	return r.ApiService.GetQpsHistoriesExecute(r)
}

/*
GetQpsHistories 月別のQPSの一覧取得
...
ゾーンおよびLBドメインのクエリ数を元に集計したDPF契約の月別のQPSが取得できます。
	...
	@param contractId ID
	@return ApiGetQpsHistoriesRequest
*/
func (a *QpsAPIService) GetQpsHistories(ctx context.Context, contractId string) ApiGetQpsHistoriesRequest {
	return ApiGetQpsHistoriesRequest{
		ApiService: a,
		ctx:        ctx,
...
//
//	@return GetQpsHistories
func (a *QpsAPIService) GetQpsHistoriesExecute(r ApiGetQpsHistoriesRequest) (*GetQpsHistories, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetQpsHistories
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QpsAPIService.GetQpsHistories")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/contracts/{ContractId}/qps/histories"
