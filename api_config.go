...
type ApiGetConfigListRequest struct {
	ctx        context.Context
	ApiService *ConfigAPIService
	lbDomainId string
}

func (r ApiGetConfigListRequest) Execute() (*GetConfig, *http.Response, error) {
	return r.ApiService.GetConfigListExecute(r)
}

/*
GetConfigList 設定の一覧取得

設定の一覧を取得します。

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param lbDomainId GET lb_domains Schemaにおける id
	@return ApiGetConfigListRequest
*/
func (a *ConfigAPIService) GetConfigList(ctx context.Context, lbDomainId string) ApiGetConfigListRequest {
	return ApiGetConfigListRequest{
		ApiService: a,
		ctx:        ctx,
...
//
//	@return GetConfig
func (a *ConfigAPIService) GetConfigListExecute(r ApiGetConfigListRequest) (*GetConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetConfig
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigAPIService.GetConfigList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/lb_domains/{LbDomainId}/config"
...
func (r ApiPutConfigRequest) PutConfig(putConfig PutConfig) ApiPutConfigRequest {
	r.putConfig = &putConfig
	return r
}

func (r ApiPutConfigRequest) Execute() (*AsyncResponse, *http.Response, error) {
...
*/
func (a *ConfigAPIService) PutConfig(ctx context.Context, lbDomainId string) ApiPutConfigRequest {
	return ApiPutConfigRequest{
		ApiService: a,
		ctx:        ctx,
		lbDomainId: lbDomainId,
...
func (a *ConfigAPIService) PutConfigExecute(r ApiPutConfigRequest) (*AsyncResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigAPIService.PutConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.putConfig == nil {
		return localVarReturnValue, nil, reportError("putConfig is required and must be specified")
	}
