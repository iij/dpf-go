...
// checks if the GetRuleMethods type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRuleMethods{}

// GetRuleMethods struct for GetRuleMethods
type GetRuleMethods struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string       `json:"request_id"`
	Results   []RuleMethod `json:"results"`
}

type _GetRuleMethods GetRuleMethods
...
func (o GetRuleMethods) MarshalJSON() ([]byte, error) {
...
func (o GetRuleMethods) ToMap() (map[string]interface{}, error) {
...
func (o *GetRuleMethods) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRuleMethods := _GetRuleMethods{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRuleMethods)

	if err != nil {
		return err
	}

	*o = GetRuleMethods(varGetRuleMethods)

	return err
}

type NullableGetRuleMethods struct {
	value *GetRuleMethods
	isSet bool
}

func (v NullableGetRuleMethods) Get() *GetRuleMethods {
	return v.value
}

func (v *NullableGetRuleMethods) Set(val *GetRuleMethods) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRuleMethods) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRuleMethods) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRuleMethods(val *GetRuleMethods) *NullableGetRuleMethods {
	return &NullableGetRuleMethods{value: val, isSet: true}
}

func (v NullableGetRuleMethods) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRuleMethods) UnmarshalJSON(src []byte) error {
	v.isSet = true
