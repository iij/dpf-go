...
// checks if the GetSites type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSites{}
...
// NewGetSites instantiates a new GetSites object
...
// NewGetSitesWithDefaults instantiates a new GetSites object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetSitesWithDefaults() *GetSites {
	this := GetSites{}
	return &this
}

// GetRequestId returns the RequestId field value
func (o *GetSites) GetRequestId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GetSites) GetRequestIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetSites) SetRequestId(v string) {
	o.RequestId = v
}
...
func (o GetSites) MarshalJSON() ([]byte, error) {
...
func (o GetSites) ToMap() (map[string]interface{}, error) {
...
func (o *GetSites) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSites := _GetSites{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetSites)

	if err != nil {
		return err
	}

	*o = GetSites(varGetSites)

	return err
}

type NullableGetSites struct {
	value *GetSites
	isSet bool
}

func (v NullableGetSites) Get() *GetSites {
	return v.value
}

func (v *NullableGetSites) Set(val *GetSites) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSites) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSites) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSites(val *GetSites) *NullableGetSites {
	return &NullableGetSites{value: val, isSet: true}
}

func (v NullableGetSites) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSites) UnmarshalJSON(src []byte) error {
	v.isSet = true
