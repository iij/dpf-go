...
// checks if the GetContractPartners type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetContractPartners{}

// GetContractPartners struct for GetContractPartners
type GetContractPartners struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string                            `json:"request_id"`
	Results   []GetContractPartnersResultsInner `json:"results"`
}

type _GetContractPartners GetContractPartners
...
func (o *GetContractPartners) GetResults() []GetContractPartnersResultsInner {
	if o == nil {
		var ret []GetContractPartnersResultsInner
		return ret
	}
...
func (o GetContractPartners) MarshalJSON() ([]byte, error) {
...
func (o GetContractPartners) ToMap() (map[string]interface{}, error) {
...
func (o *GetContractPartners) UnmarshalJSON(data []byte) (err error) {
	...
	varGetContractPartners := _GetContractPartners{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetContractPartners)

	if err != nil {
		return err
	}

	*o = GetContractPartners(varGetContractPartners)

	return err
}

type NullableGetContractPartners struct {
	value *GetContractPartners
	isSet bool
}

func (v NullableGetContractPartners) Get() *GetContractPartners {
	return v.value
}

func (v *NullableGetContractPartners) Set(val *GetContractPartners) {
	v.value = val
	v.isSet = true
}

func (v NullableGetContractPartners) IsSet() bool {
	return v.isSet
}

func (v *NullableGetContractPartners) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetContractPartners(val *GetContractPartners) *NullableGetContractPartners {
	return &NullableGetContractPartners{value: val, isSet: true}
}

func (v NullableGetContractPartners) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetContractPartners) UnmarshalJSON(src []byte) error {
	v.isSet = true
