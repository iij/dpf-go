...
// checks if the LbDomain type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LbDomain{}
...
func (o *LbDomain) UnmarshalJSON(data []byte) (err error) {
	...
	varLbDomain := _LbDomain{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLbDomain)

	if err != nil {
		return err
	}

	*o = LbDomain(varLbDomain)

	return err
}

type NullableLbDomain struct {
	value *LbDomain
	isSet bool
}

func (v NullableLbDomain) Get() *LbDomain {
	return v.value
}

func (v *NullableLbDomain) Set(val *LbDomain) {
	v.value = val
	v.isSet = true
}

func (v NullableLbDomain) IsSet() bool {
	return v.isSet
}

func (v *NullableLbDomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLbDomain(val *LbDomain) *NullableLbDomain {
	return &NullableLbDomain{value: val, isSet: true}
}

func (v NullableLbDomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLbDomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
