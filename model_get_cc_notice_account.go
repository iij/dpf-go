...
// checks if the GetCcNoticeAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCcNoticeAccount{}

// GetCcNoticeAccount struct for GetCcNoticeAccount
type GetCcNoticeAccount struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string          `json:"request_id"`
	Result    CcNoticeAccount `json:"result"`
}

type _GetCcNoticeAccount GetCcNoticeAccount
...
func (o GetCcNoticeAccount) MarshalJSON() ([]byte, error) {
...
func (o GetCcNoticeAccount) ToMap() (map[string]interface{}, error) {
...
func (o *GetCcNoticeAccount) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCcNoticeAccount := _GetCcNoticeAccount{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCcNoticeAccount)

	if err != nil {
		return err
	}

	*o = GetCcNoticeAccount(varGetCcNoticeAccount)

	return err
}

type NullableGetCcNoticeAccount struct {
	value *GetCcNoticeAccount
	isSet bool
}

func (v NullableGetCcNoticeAccount) Get() *GetCcNoticeAccount {
	return v.value
}

func (v *NullableGetCcNoticeAccount) Set(val *GetCcNoticeAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCcNoticeAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCcNoticeAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCcNoticeAccount(val *GetCcNoticeAccount) *NullableGetCcNoticeAccount {
	return &NullableGetCcNoticeAccount{value: val, isSet: true}
}

func (v NullableGetCcNoticeAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCcNoticeAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
