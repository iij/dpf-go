...
// checks if the EndpointMonitoringResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EndpointMonitoringResult{}

// EndpointMonitoringResult struct for EndpointMonitoringResult
type EndpointMonitoringResult struct {
	// エンドポイントと監視の紐付けの成功しているかどうかの状態
	Result string `json:"result"`
}

type _EndpointMonitoringResult EndpointMonitoringResult
...
func (o EndpointMonitoringResult) MarshalJSON() ([]byte, error) {
...
func (o EndpointMonitoringResult) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["result"] = o.Result
	return toSerialize, nil
}

func (o *EndpointMonitoringResult) UnmarshalJSON(data []byte) (err error) {
	...
	varEndpointMonitoringResult := _EndpointMonitoringResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEndpointMonitoringResult)

	if err != nil {
		return err
	}

	*o = EndpointMonitoringResult(varEndpointMonitoringResult)

	return err
}

type NullableEndpointMonitoringResult struct {
	value *EndpointMonitoringResult
	isSet bool
}

func (v NullableEndpointMonitoringResult) Get() *EndpointMonitoringResult {
	return v.value
}

func (v *NullableEndpointMonitoringResult) Set(val *EndpointMonitoringResult) {
	v.value = val
	v.isSet = true
}

func (v NullableEndpointMonitoringResult) IsSet() bool {
	return v.isSet
}

func (v *NullableEndpointMonitoringResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEndpointMonitoringResult(val *EndpointMonitoringResult) *NullableEndpointMonitoringResult {
	return &NullableEndpointMonitoringResult{value: val, isSet: true}
}

func (v NullableEndpointMonitoringResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEndpointMonitoringResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
