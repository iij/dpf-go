...
// checks if the GetManagedServers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetManagedServers{}

// GetManagedServers struct for GetManagedServers
type GetManagedServers struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string   `json:"request_id"`
	Results   []string `json:"results"`
}

type _GetManagedServers GetManagedServers
...
func (o GetManagedServers) MarshalJSON() ([]byte, error) {
...
func (o GetManagedServers) ToMap() (map[string]interface{}, error) {
...
func (o *GetManagedServers) UnmarshalJSON(data []byte) (err error) {
	...
	varGetManagedServers := _GetManagedServers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetManagedServers)

	if err != nil {
		return err
	}

	*o = GetManagedServers(varGetManagedServers)

	return err
}

type NullableGetManagedServers struct {
	value *GetManagedServers
	isSet bool
}

func (v NullableGetManagedServers) Get() *GetManagedServers {
	return v.value
}

func (v *NullableGetManagedServers) Set(val *GetManagedServers) {
	v.value = val
	v.isSet = true
}

func (v NullableGetManagedServers) IsSet() bool {
	return v.isSet
}

func (v *NullableGetManagedServers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetManagedServers(val *GetManagedServers) *NullableGetManagedServers {
	return &NullableGetManagedServers{value: val, isSet: true}
}

func (v NullableGetManagedServers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetManagedServers) UnmarshalJSON(src []byte) error {
	v.isSet = true
