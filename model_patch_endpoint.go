...
// checks if the PatchEndpoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchEndpoint{}
...
func (o *PatchEndpoint) GetMonitorings() []PatchEndpointMonitoringsInner {
	if o == nil || IsNil(o.Monitorings) {
		var ret []PatchEndpointMonitoringsInner
		return ret
	}
...
// SetMonitorings gets a reference to the given []PatchEndpointMonitoringsInner and assigns it to the Monitorings field.
...
type NullablePatchEndpoint struct {
	value *PatchEndpoint
	isSet bool
}

func (v NullablePatchEndpoint) Get() *PatchEndpoint {
	return v.value
}

func (v *NullablePatchEndpoint) Set(val *PatchEndpoint) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchEndpoint) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchEndpoint) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchEndpoint(val *PatchEndpoint) *NullablePatchEndpoint {
	return &NullablePatchEndpoint{value: val, isSet: true}
}

func (v NullablePatchEndpoint) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchEndpoint) UnmarshalJSON(src []byte) error {
	v.isSet = true
