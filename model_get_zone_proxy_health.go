...
// checks if the GetZoneProxyHealth type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZoneProxyHealth{}

// GetZoneProxyHealth struct for GetZoneProxyHealth
type GetZoneProxyHealth struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string            `json:"request_id"`
	Results   []ZoneProxyHealth `json:"results"`
}

type _GetZoneProxyHealth GetZoneProxyHealth
...
func (o GetZoneProxyHealth) MarshalJSON() ([]byte, error) {
...
func (o GetZoneProxyHealth) ToMap() (map[string]interface{}, error) {
...
func (o *GetZoneProxyHealth) UnmarshalJSON(data []byte) (err error) {
	...
	varGetZoneProxyHealth := _GetZoneProxyHealth{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetZoneProxyHealth)

	if err != nil {
		return err
	}

	*o = GetZoneProxyHealth(varGetZoneProxyHealth)

	return err
}

type NullableGetZoneProxyHealth struct {
	value *GetZoneProxyHealth
	isSet bool
}

func (v NullableGetZoneProxyHealth) Get() *GetZoneProxyHealth {
	return v.value
}

func (v *NullableGetZoneProxyHealth) Set(val *GetZoneProxyHealth) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZoneProxyHealth) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZoneProxyHealth) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZoneProxyHealth(val *GetZoneProxyHealth) *NullableGetZoneProxyHealth {
	return &NullableGetZoneProxyHealth{value: val, isSet: true}
}

func (v NullableGetZoneProxyHealth) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZoneProxyHealth) UnmarshalJSON(src []byte) error {
	v.isSet = true
