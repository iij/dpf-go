...
// checks if the GetEndpoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetEndpoint{}
...
func (o GetEndpoint) MarshalJSON() ([]byte, error) {
...
func (o GetEndpoint) ToMap() (map[string]interface{}, error) {
...
func (o *GetEndpoint) UnmarshalJSON(data []byte) (err error) {
	...
	varGetEndpoint := _GetEndpoint{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetEndpoint)

	if err != nil {
		return err
	}

	*o = GetEndpoint(varGetEndpoint)

	return err
}

type NullableGetEndpoint struct {
	value *GetEndpoint
	isSet bool
}

func (v NullableGetEndpoint) Get() *GetEndpoint {
	return v.value
}

func (v *NullableGetEndpoint) Set(val *GetEndpoint) {
	v.value = val
	v.isSet = true
}

func (v NullableGetEndpoint) IsSet() bool {
	return v.isSet
}

func (v *NullableGetEndpoint) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetEndpoint(val *GetEndpoint) *NullableGetEndpoint {
	return &NullableGetEndpoint{value: val, isSet: true}
}

func (v NullableGetEndpoint) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetEndpoint) UnmarshalJSON(src []byte) error {
	v.isSet = true
