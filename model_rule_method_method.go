...
// checks if the RuleMethodMethod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleMethodMethod{}

// RuleMethodMethod struct for RuleMethodMethod
type RuleMethodMethod struct {
...
type _RuleMethodMethod RuleMethodMethod
...
func (o RuleMethodMethod) MarshalJSON() ([]byte, error) {
...
func (o RuleMethodMethod) ToMap() (map[string]interface{}, error) {
...
func (o *RuleMethodMethod) UnmarshalJSON(data []byte) (err error) {
	...
	varRuleMethodMethod := _RuleMethodMethod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRuleMethodMethod)

	if err != nil {
		return err
	}

	*o = RuleMethodMethod(varRuleMethodMethod)

	return err
}

type NullableRuleMethodMethod struct {
	value *RuleMethodMethod
	isSet bool
}

func (v NullableRuleMethodMethod) Get() *RuleMethodMethod {
	return v.value
}

func (v *NullableRuleMethodMethod) Set(val *RuleMethodMethod) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleMethodMethod) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleMethodMethod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleMethodMethod(val *RuleMethodMethod) *NullableRuleMethodMethod {
	return &NullableRuleMethodMethod{value: val, isSet: true}
}

func (v NullableRuleMethodMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleMethodMethod) UnmarshalJSON(src []byte) error {
	v.isSet = true
