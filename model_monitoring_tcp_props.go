...
// checks if the MonitoringTCPProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonitoringTCPProps{}
...
type _MonitoringTCPProps MonitoringTCPProps
...
func (o MonitoringTCPProps) MarshalJSON() ([]byte, error) {
...
func (o *MonitoringTCPProps) UnmarshalJSON(data []byte) (err error) {
	...
	varMonitoringTCPProps := _MonitoringTCPProps{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMonitoringTCPProps)

	if err != nil {
		return err
	}

	*o = MonitoringTCPProps(varMonitoringTCPProps)

	return err
}

type NullableMonitoringTCPProps struct {
	value *MonitoringTCPProps
	isSet bool
}

func (v NullableMonitoringTCPProps) Get() *MonitoringTCPProps {
	return v.value
}

func (v *NullableMonitoringTCPProps) Set(val *MonitoringTCPProps) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitoringTCPProps) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitoringTCPProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitoringTCPProps(val *MonitoringTCPProps) *NullableMonitoringTCPProps {
	return &NullableMonitoringTCPProps{value: val, isSet: true}
}

func (v NullableMonitoringTCPProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitoringTCPProps) UnmarshalJSON(src []byte) error {
	v.isSet = true
