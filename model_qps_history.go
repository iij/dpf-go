...
// checks if the QpsHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QpsHistory{}
...
func (o QpsHistory) MarshalJSON() ([]byte, error) {
...
func (o *QpsHistory) UnmarshalJSON(data []byte) (err error) {
	...
	varQpsHistory := _QpsHistory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQpsHistory)

	if err != nil {
		return err
	}

	*o = QpsHistory(varQpsHistory)

	return err
}

type NullableQpsHistory struct {
	value *QpsHistory
	isSet bool
}

func (v NullableQpsHistory) Get() *QpsHistory {
	return v.value
}

func (v *NullableQpsHistory) Set(val *QpsHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableQpsHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableQpsHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQpsHistory(val *QpsHistory) *NullableQpsHistory {
	return &NullableQpsHistory{value: val, isSet: true}
}

func (v NullableQpsHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQpsHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
