...
// checks if the CommonConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonConfig{}
...
func (o *CommonConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonConfig := _CommonConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonConfig)

	if err != nil {
		return err
	}

	*o = CommonConfig(varCommonConfig)

	return err
}

type NullableCommonConfig struct {
	value *CommonConfig
	isSet bool
}

func (v NullableCommonConfig) Get() *CommonConfig {
	return v.value
}

func (v *NullableCommonConfig) Set(val *CommonConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonConfig(val *CommonConfig) *NullableCommonConfig {
	return &NullableCommonConfig{value: val, isSet: true}
}

func (v NullableCommonConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
