...
// checks if the PatchZoneAtomicChanges type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchZoneAtomicChanges{}
...
func (o *PatchZoneAtomicChanges) GetOverwriteSoa() bool {
	if o == nil || IsNil(o.OverwriteSoa) {
		var ret bool
		return ret
	}
	return *o.OverwriteSoa
}

// GetOverwriteSoaOk returns a tuple with the OverwriteSoa field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PatchZoneAtomicChanges) GetOverwriteSoaOk() (*bool, bool) {
	if o == nil || IsNil(o.OverwriteSoa) {
		return nil, false
	}
	return o.OverwriteSoa, true
}
...
// SetOverwriteSoa gets a reference to the given bool and assigns it to the OverwriteSoa field.
func (o *PatchZoneAtomicChanges) SetOverwriteSoa(v bool) {
	o.OverwriteSoa = &v
}

// GetOverwriteZoneApexNs returns the OverwriteZoneApexNs field value if set, zero value otherwise.
func (o *PatchZoneAtomicChanges) GetOverwriteZoneApexNs() bool {
	if o == nil || IsNil(o.OverwriteZoneApexNs) {
		var ret bool
		return ret
	}
	return *o.OverwriteZoneApexNs
}

// GetOverwriteZoneApexNsOk returns a tuple with the OverwriteZoneApexNs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PatchZoneAtomicChanges) GetOverwriteZoneApexNsOk() (*bool, bool) {
	if o == nil || IsNil(o.OverwriteZoneApexNs) {
		return nil, false
	}
	return o.OverwriteZoneApexNs, true
}
...
// SetOverwriteZoneApexNs gets a reference to the given bool and assigns it to the OverwriteZoneApexNs field.
...
func (o *PatchZoneAtomicChanges) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchZoneAtomicChanges := _PatchZoneAtomicChanges{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPatchZoneAtomicChanges)

	if err != nil {
		return err
	}

	*o = PatchZoneAtomicChanges(varPatchZoneAtomicChanges)

	return err
}

type NullablePatchZoneAtomicChanges struct {
	value *PatchZoneAtomicChanges
	isSet bool
}

func (v NullablePatchZoneAtomicChanges) Get() *PatchZoneAtomicChanges {
	return v.value
}

func (v *NullablePatchZoneAtomicChanges) Set(val *PatchZoneAtomicChanges) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchZoneAtomicChanges) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchZoneAtomicChanges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchZoneAtomicChanges(val *PatchZoneAtomicChanges) *NullablePatchZoneAtomicChanges {
	return &NullablePatchZoneAtomicChanges{value: val, isSet: true}
}

func (v NullablePatchZoneAtomicChanges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchZoneAtomicChanges) UnmarshalJSON(src []byte) error {
	v.isSet = true
