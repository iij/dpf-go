...
// checks if the GetLbDomainLabels type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLbDomainLabels{}

// GetLbDomainLabels struct for GetLbDomainLabels
type GetLbDomainLabels struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string         `json:"request_id"`
	Result    LbDomainLabels `json:"result"`
}

type _GetLbDomainLabels GetLbDomainLabels
...
func (o GetLbDomainLabels) MarshalJSON() ([]byte, error) {
...
func (o GetLbDomainLabels) ToMap() (map[string]interface{}, error) {
...
func (o *GetLbDomainLabels) UnmarshalJSON(data []byte) (err error) {
	...
	varGetLbDomainLabels := _GetLbDomainLabels{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetLbDomainLabels)

	if err != nil {
		return err
	}

	*o = GetLbDomainLabels(varGetLbDomainLabels)

	return err
}

type NullableGetLbDomainLabels struct {
	value *GetLbDomainLabels
	isSet bool
}

func (v NullableGetLbDomainLabels) Get() *GetLbDomainLabels {
	return v.value
}

func (v *NullableGetLbDomainLabels) Set(val *GetLbDomainLabels) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLbDomainLabels) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLbDomainLabels) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLbDomainLabels(val *GetLbDomainLabels) *NullableGetLbDomainLabels {
	return &NullableGetLbDomainLabels{value: val, isSet: true}
}

func (v NullableGetLbDomainLabels) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLbDomainLabels) UnmarshalJSON(src []byte) error {
	v.isSet = true
