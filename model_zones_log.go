...
// checks if the ZonesLog type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZonesLog{}

// ZonesLog struct for ZonesLog
type ZonesLog struct {
	Time    time.Time     `json:"time"`
	LogType ZonesLogsType `json:"log_type"`
	// 編集者
	Operator  NullableString     `json:"operator"`
	Operation ZonesLogsOperation `json:"operation"`
	Target    string             `json:"target"`
	// 処理の問い合わせの際のキーになる文字列
	RequestId string          `json:"request_id"`
	Status    ZonesLogsStatus `json:"status"`
}

type _ZonesLog ZonesLog
...
func (o ZonesLog) MarshalJSON() ([]byte, error) {
...
func (o ZonesLog) ToMap() (map[string]interface{}, error) {
...
func (o *ZonesLog) UnmarshalJSON(data []byte) (err error) {
	...
	varZonesLog := _ZonesLog{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varZonesLog)

	if err != nil {
		return err
	}

	*o = ZonesLog(varZonesLog)

	return err
}

type NullableZonesLog struct {
	value *ZonesLog
	isSet bool
}

func (v NullableZonesLog) Get() *ZonesLog {
	return v.value
}

func (v *NullableZonesLog) Set(val *ZonesLog) {
	v.value = val
	v.isSet = true
}

func (v NullableZonesLog) IsSet() bool {
	return v.isSet
}

func (v *NullableZonesLog) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZonesLog(val *ZonesLog) *NullableZonesLog {
	return &NullableZonesLog{value: val, isSet: true}
}

func (v NullableZonesLog) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZonesLog) UnmarshalJSON(src []byte) error {
	v.isSet = true
