...
// checks if the GetCcNoticeAccounts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCcNoticeAccounts{}

// GetCcNoticeAccounts struct for GetCcNoticeAccounts
type GetCcNoticeAccounts struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string            `json:"request_id"`
	Results   []CcNoticeAccount `json:"results"`
}

type _GetCcNoticeAccounts GetCcNoticeAccounts
...
func (o GetCcNoticeAccounts) MarshalJSON() ([]byte, error) {
...
func (o GetCcNoticeAccounts) ToMap() (map[string]interface{}, error) {
...
func (o *GetCcNoticeAccounts) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCcNoticeAccounts := _GetCcNoticeAccounts{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCcNoticeAccounts)

	if err != nil {
		return err
	}

	*o = GetCcNoticeAccounts(varGetCcNoticeAccounts)

	return err
}

type NullableGetCcNoticeAccounts struct {
	value *GetCcNoticeAccounts
	isSet bool
}

func (v NullableGetCcNoticeAccounts) Get() *GetCcNoticeAccounts {
	return v.value
}

func (v *NullableGetCcNoticeAccounts) Set(val *GetCcNoticeAccounts) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCcNoticeAccounts) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCcNoticeAccounts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCcNoticeAccounts(val *GetCcNoticeAccounts) *NullableGetCcNoticeAccounts {
	return &NullableGetCcNoticeAccounts{value: val, isSet: true}
}

func (v NullableGetCcNoticeAccounts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCcNoticeAccounts) UnmarshalJSON(src []byte) error {
	v.isSet = true
