...
// checks if the GetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetConfig{}

// GetConfig struct for GetConfig
...
func (o GetConfig) MarshalJSON() ([]byte, error) {
...
func (o GetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *GetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varGetConfig := _GetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetConfig)

	if err != nil {
		return err
	}

	*o = GetConfig(varGetConfig)

	return err
}

type NullableGetConfig struct {
	value *GetConfig
	isSet bool
}

func (v NullableGetConfig) Get() *GetConfig {
	return v.value
}

func (v *NullableGetConfig) Set(val *GetConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetConfig(val *GetConfig) *NullableGetConfig {
	return &NullableGetConfig{value: val, isSet: true}
}

func (v NullableGetConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
