...
// checks if the PatchRuleMethod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchRuleMethod{}
...
// SetMethod gets a reference to the given PatchRuleMethodMethod and assigns it to the Method field.
...
type NullablePatchRuleMethod struct {
	value *PatchRuleMethod
	isSet bool
}

func (v NullablePatchRuleMethod) Get() *PatchRuleMethod {
	return v.value
}

func (v *NullablePatchRuleMethod) Set(val *PatchRuleMethod) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchRuleMethod) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchRuleMethod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchRuleMethod(val *PatchRuleMethod) *NullablePatchRuleMethod {
	return &NullablePatchRuleMethod{value: val, isSet: true}
}

func (v NullablePatchRuleMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchRuleMethod) UnmarshalJSON(src []byte) error {
	v.isSet = true
