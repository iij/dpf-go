...
// checks if the GetSite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSite{}

// GetSite struct for GetSite
type GetSite struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string               `json:"request_id"`
	Result    GetSitesResultsInner `json:"result"`
}

type _GetSite GetSite
...
func (o GetSite) MarshalJSON() ([]byte, error) {
...
func (o GetSite) ToMap() (map[string]interface{}, error) {
...
func (o *GetSite) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varGetSite)

	if err != nil {
		return err
	}

	*o = GetSite(varGetSite)

	return err
}

type NullableGetSite struct {
	value *GetSite
	isSet bool
}

func (v NullableGetSite) Get() *GetSite {
	return v.value
}

func (v *NullableGetSite) Set(val *GetSite) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSite) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSite) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSite(val *GetSite) *NullableGetSite {
	return &NullableGetSite{value: val, isSet: true}
}

func (v NullableGetSite) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSite) UnmarshalJSON(src []byte) error {
	v.isSet = true
