...
// checks if the LbDomainsLog type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LbDomainsLog{}

// LbDomainsLog struct for LbDomainsLog
type LbDomainsLog struct {
	Time    time.Time         `json:"time"`
	LogType LbDomainsLogsType `json:"log_type"`
	// 編集者
	Operator  NullableString         `json:"operator"`
	Operation LbDomainsLogsOperation `json:"operation"`
	Target    string                 `json:"target"`
	// 処理の問い合わせの際のキーになる文字列
	RequestId string              `json:"request_id"`
	Status    LbDomainsLogsStatus `json:"status"`
}

type _LbDomainsLog LbDomainsLog
...
func (o *LbDomainsLog) GetOperation() LbDomainsLogsOperation {
	if o == nil {
		var ret LbDomainsLogsOperation
		return ret
	}
...
func (o LbDomainsLog) MarshalJSON() ([]byte, error) {
...
func (o LbDomainsLog) ToMap() (map[string]interface{}, error) {
...
func (o *LbDomainsLog) UnmarshalJSON(data []byte) (err error) {
	...
	varLbDomainsLog := _LbDomainsLog{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLbDomainsLog)

	if err != nil {
		return err
	}

	*o = LbDomainsLog(varLbDomainsLog)

	return err
}

type NullableLbDomainsLog struct {
	value *LbDomainsLog
	isSet bool
}

func (v NullableLbDomainsLog) Get() *LbDomainsLog {
	return v.value
}

func (v *NullableLbDomainsLog) Set(val *LbDomainsLog) {
	v.value = val
	v.isSet = true
}

func (v NullableLbDomainsLog) IsSet() bool {
	return v.isSet
}

func (v *NullableLbDomainsLog) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLbDomainsLog(val *LbDomainsLog) *NullableLbDomainsLog {
	return &NullableLbDomainsLog{value: val, isSet: true}
}

func (v NullableLbDomainsLog) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLbDomainsLog) UnmarshalJSON(src []byte) error {
	v.isSet = true
