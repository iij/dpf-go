...
// checks if the PostRuleMethod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostRuleMethod{}
...
// NewPostRuleMethod instantiates a new PostRuleMethod object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostRuleMethod(method PostRuleMethodMethod) *PostRuleMethod {
	this := PostRuleMethod{}
	this.Method = method
	return &this
}

// NewPostRuleMethodWithDefaults instantiates a new PostRuleMethod object
...
func (o *PostRuleMethod) GetPriority() int32 {
...
func (o *PostRuleMethod) GetPriorityOk() (*int32, bool) {
	if o == nil || IsNil(o.Priority) {
		return nil, false
	}
...
func (o *PostRuleMethod) HasPriority() bool {
	if o != nil && !IsNil(o.Priority) {
		return true
	}
...
func (o *PostRuleMethod) SetPriority(v int32) {
	o.Priority = &v
}
...
func (o *PostRuleMethod) UnmarshalJSON(data []byte) (err error) {
	...
	varPostRuleMethod := _PostRuleMethod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostRuleMethod)

	if err != nil {
		return err
	}

	*o = PostRuleMethod(varPostRuleMethod)

	return err
}

type NullablePostRuleMethod struct {
	value *PostRuleMethod
	isSet bool
}

func (v NullablePostRuleMethod) Get() *PostRuleMethod {
	return v.value
}

func (v *NullablePostRuleMethod) Set(val *PostRuleMethod) {
	v.value = val
	v.isSet = true
}

func (v NullablePostRuleMethod) IsSet() bool {
	return v.isSet
}

func (v *NullablePostRuleMethod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostRuleMethod(val *PostRuleMethod) *NullablePostRuleMethod {
	return &NullablePostRuleMethod{value: val, isSet: true}
}

func (v NullablePostRuleMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostRuleMethod) UnmarshalJSON(src []byte) error {
	v.isSet = true
