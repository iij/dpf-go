...
// checks if the GetEndpointsResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetEndpointsResultsInner{}

// GetEndpointsResultsInner struct for GetEndpointsResultsInner
type GetEndpointsResultsInner struct {
	...
	Monitorings []EndpointMonitoringsMonitoringsInner `json:"monitorings,omitempty"`
}

type _GetEndpointsResultsInner GetEndpointsResultsInner

// NewGetEndpointsResultsInner instantiates a new GetEndpointsResultsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetEndpointsResultsInner(resourceName string, name string, monitoringTarget string, description string, weight int32, manualFailback bool, manualFailover bool, enabled bool, liveStatus EndpointLiveStatus, readyStatus EndpointReadyStatus, rdata []EndpointRdataInner) *GetEndpointsResultsInner {
	this := GetEndpointsResultsInner{}
...
func (o *GetEndpointsResultsInner) GetMonitorings() []EndpointMonitoringsMonitoringsInner {
	if o == nil || IsNil(o.Monitorings) {
		var ret []EndpointMonitoringsMonitoringsInner
		return ret
	}
...
func (o *GetEndpointsResultsInner) HasMonitorings() bool {
	if o != nil && !IsNil(o.Monitorings) {
		return true
	}
...
// SetMonitorings gets a reference to the given []EndpointMonitoringsMonitoringsInner and assigns it to the Monitorings field.
func (o *GetEndpointsResultsInner) SetMonitorings(v []EndpointMonitoringsMonitoringsInner) {
	o.Monitorings = v
}

func (o GetEndpointsResultsInner) MarshalJSON() ([]byte, error) {
...
func (o GetEndpointsResultsInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetEndpointsResultsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetEndpointsResultsInner := _GetEndpointsResultsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetEndpointsResultsInner)

	if err != nil {
		return err
	}

	*o = GetEndpointsResultsInner(varGetEndpointsResultsInner)

	return err
}

type NullableGetEndpointsResultsInner struct {
	value *GetEndpointsResultsInner
	isSet bool
}

func (v NullableGetEndpointsResultsInner) Get() *GetEndpointsResultsInner {
	return v.value
}

func (v *NullableGetEndpointsResultsInner) Set(val *GetEndpointsResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetEndpointsResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetEndpointsResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetEndpointsResultsInner(val *GetEndpointsResultsInner) *NullableGetEndpointsResultsInner {
	return &NullableGetEndpointsResultsInner{value: val, isSet: true}
}

func (v NullableGetEndpointsResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetEndpointsResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
