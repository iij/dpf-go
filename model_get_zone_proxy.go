...
// checks if the GetZoneProxy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZoneProxy{}

// GetZoneProxy struct for GetZoneProxy
type GetZoneProxy struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string    `json:"request_id"`
	Result    ZoneProxy `json:"result"`
}

type _GetZoneProxy GetZoneProxy
...
func (o GetZoneProxy) MarshalJSON() ([]byte, error) {
...
func (o GetZoneProxy) ToMap() (map[string]interface{}, error) {
...
func (o *GetZoneProxy) UnmarshalJSON(data []byte) (err error) {
	...
	varGetZoneProxy := _GetZoneProxy{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetZoneProxy)

	if err != nil {
		return err
	}

	*o = GetZoneProxy(varGetZoneProxy)

	return err
}

type NullableGetZoneProxy struct {
	value *GetZoneProxy
	isSet bool
}

func (v NullableGetZoneProxy) Get() *GetZoneProxy {
	return v.value
}

func (v *NullableGetZoneProxy) Set(val *GetZoneProxy) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZoneProxy) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZoneProxy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZoneProxy(val *GetZoneProxy) *NullableGetZoneProxy {
	return &NullableGetZoneProxy{value: val, isSet: true}
}

func (v NullableGetZoneProxy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZoneProxy) UnmarshalJSON(src []byte) error {
	v.isSet = true
