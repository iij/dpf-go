...
// checks if the PostSite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSite{}
...
// NewPostSite instantiates a new PostSite object
...
// NewPostSiteWithDefaults instantiates a new PostSite object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPostSiteWithDefaults() *PostSite {
	this := PostSite{}
	var description string = ""
	this.Description = &description
	return &this
...
func (o *PostSite) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *PostSite) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *PostSite) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *PostSite) SetDescription(v string) {
	o.Description = &v
}
...
func (o *PostSite) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSite := _PostSite{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSite)

	if err != nil {
		return err
	}

	*o = PostSite(varPostSite)

	return err
}

type NullablePostSite struct {
	value *PostSite
	isSet bool
}

func (v NullablePostSite) Get() *PostSite {
	return v.value
}

func (v *NullablePostSite) Set(val *PostSite) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSite) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSite) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSite(val *PostSite) *NullablePostSite {
	return &NullablePostSite{value: val, isSet: true}
}

func (v NullablePostSite) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSite) UnmarshalJSON(src []byte) error {
	v.isSet = true
