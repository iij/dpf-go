...
// checks if the QpsValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QpsValue{}

// QpsValue struct for QpsValue
...
// GetQps returns the Qps field value
...
// GetQpsOk returns a tuple with the Qps field value
// and a boolean to check if the value has been set.
...
// SetQps sets field value
func (o *QpsValue) SetQps(v int32) {
	o.Qps = v
}

func (o QpsValue) MarshalJSON() ([]byte, error) {
...
func (o QpsValue) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["month"] = o.Month
	toSerialize["qps"] = o.Qps
	return toSerialize, nil
}

func (o *QpsValue) UnmarshalJSON(data []byte) (err error) {
	...
	varQpsValue := _QpsValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQpsValue)

	if err != nil {
		return err
	}

	*o = QpsValue(varQpsValue)

	return err
}

type NullableQpsValue struct {
	value *QpsValue
	isSet bool
}

func (v NullableQpsValue) Get() *QpsValue {
	return v.value
}

func (v *NullableQpsValue) Set(val *QpsValue) {
	v.value = val
	v.isSet = true
}

func (v NullableQpsValue) IsSet() bool {
	return v.isSet
}

func (v *NullableQpsValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQpsValue(val *QpsValue) *NullableQpsValue {
	return &NullableQpsValue{value: val, isSet: true}
}

func (v NullableQpsValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQpsValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
