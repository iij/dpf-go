...
// checks if the PatchZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchZone{}
...
type NullablePatchZone struct {
	value *PatchZone
	isSet bool
}

func (v NullablePatchZone) Get() *PatchZone {
	return v.value
}

func (v *NullablePatchZone) Set(val *PatchZone) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchZone) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchZone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchZone(val *PatchZone) *NullablePatchZone {
	return &NullablePatchZone{value: val, isSet: true}
}

func (v NullablePatchZone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchZone) UnmarshalJSON(src []byte) error {
	v.isSet = true
