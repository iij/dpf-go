...
// checks if the RuleMethodsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleMethodsInner{}

// RuleMethodsInner struct for RuleMethodsInner
type RuleMethodsInner struct {
	// 優先度（親メソッドが failover の場合のみ指定）
	Priority *int32           `json:"priority,omitempty"`
	Method   RuleMethodMethod `json:"method"`
}

type _RuleMethodsInner RuleMethodsInner
...
func (o RuleMethodsInner) MarshalJSON() ([]byte, error) {
...
func (o RuleMethodsInner) ToMap() (map[string]interface{}, error) {
...
func (o *RuleMethodsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRuleMethodsInner := _RuleMethodsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRuleMethodsInner)

	if err != nil {
		return err
	}

	*o = RuleMethodsInner(varRuleMethodsInner)

	return err
}

type NullableRuleMethodsInner struct {
	value *RuleMethodsInner
	isSet bool
}

func (v NullableRuleMethodsInner) Get() *RuleMethodsInner {
	return v.value
}

func (v *NullableRuleMethodsInner) Set(val *RuleMethodsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleMethodsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleMethodsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleMethodsInner(val *RuleMethodsInner) *NullableRuleMethodsInner {
	return &NullableRuleMethodsInner{value: val, isSet: true}
}

func (v NullableRuleMethodsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleMethodsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
