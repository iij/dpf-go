...
// checks if the PostMonitoringPing type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostMonitoringPing{}
...
func (o *PostMonitoringPing) UnmarshalJSON(data []byte) (err error) {
	...
	varPostMonitoringPing := _PostMonitoringPing{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostMonitoringPing)

	if err != nil {
		return err
	}

	*o = PostMonitoringPing(varPostMonitoringPing)

	return err
}

type NullablePostMonitoringPing struct {
	value *PostMonitoringPing
	isSet bool
}

func (v NullablePostMonitoringPing) Get() *PostMonitoringPing {
	return v.value
}

func (v *NullablePostMonitoringPing) Set(val *PostMonitoringPing) {
	v.value = val
	v.isSet = true
}

func (v NullablePostMonitoringPing) IsSet() bool {
	return v.isSet
}

func (v *NullablePostMonitoringPing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostMonitoringPing(val *PostMonitoringPing) *NullablePostMonitoringPing {
	return &NullablePostMonitoringPing{value: val, isSet: true}
}

func (v NullablePostMonitoringPing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostMonitoringPing) UnmarshalJSON(src []byte) error {
	v.isSet = true
