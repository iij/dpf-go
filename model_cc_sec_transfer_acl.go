...
// checks if the CcSecTransferAcl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CcSecTransferAcl{}

// CcSecTransferAcl struct for CcSecTransferAcl
...
type _CcSecTransferAcl CcSecTransferAcl
...
// GetTsigIdOk returns a tuple with the TsigId field value
// and a boolean to check if the value has been set.
...
// SetTsigId sets field value
func (o *CcSecTransferAcl) SetTsigId(v int64) {
	o.TsigId.Set(&v)
}

func (o CcSecTransferAcl) MarshalJSON() ([]byte, error) {
...
func (o CcSecTransferAcl) ToMap() (map[string]interface{}, error) {
...
func (o *CcSecTransferAcl) UnmarshalJSON(data []byte) (err error) {
	...
	varCcSecTransferAcl := _CcSecTransferAcl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCcSecTransferAcl)

	if err != nil {
		return err
	}

	*o = CcSecTransferAcl(varCcSecTransferAcl)

	return err
}

type NullableCcSecTransferAcl struct {
	value *CcSecTransferAcl
	isSet bool
}

func (v NullableCcSecTransferAcl) Get() *CcSecTransferAcl {
	return v.value
}

func (v *NullableCcSecTransferAcl) Set(val *CcSecTransferAcl) {
	v.value = val
	v.isSet = true
}

func (v NullableCcSecTransferAcl) IsSet() bool {
	return v.isSet
}

func (v *NullableCcSecTransferAcl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcSecTransferAcl(val *CcSecTransferAcl) *NullableCcSecTransferAcl {
	return &NullableCcSecTransferAcl{value: val, isSet: true}
}

func (v NullableCcSecTransferAcl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCcSecTransferAcl) UnmarshalJSON(src []byte) error {
	v.isSet = true
