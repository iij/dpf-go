...
// checks if the GetLbDomain type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLbDomain{}

// GetLbDomain struct for GetLbDomain
type GetLbDomain struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string   `json:"request_id"`
	Result    LbDomain `json:"result"`
}

type _GetLbDomain GetLbDomain
...
func (o GetLbDomain) MarshalJSON() ([]byte, error) {
...
func (o GetLbDomain) ToMap() (map[string]interface{}, error) {
...
func (o *GetLbDomain) UnmarshalJSON(data []byte) (err error) {
	...
	varGetLbDomain := _GetLbDomain{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetLbDomain)

	if err != nil {
		return err
	}

	*o = GetLbDomain(varGetLbDomain)

	return err
}

type NullableGetLbDomain struct {
	value *GetLbDomain
	isSet bool
}

func (v NullableGetLbDomain) Get() *GetLbDomain {
	return v.value
}

func (v *NullableGetLbDomain) Set(val *GetLbDomain) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLbDomain) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLbDomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLbDomain(val *GetLbDomain) *NullableGetLbDomain {
	return &NullableGetLbDomain{value: val, isSet: true}
}

func (v NullableGetLbDomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLbDomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
